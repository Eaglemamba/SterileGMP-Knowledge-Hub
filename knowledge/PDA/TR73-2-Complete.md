...
=== PDF PAGE 1 ===
Application of Medical Device Regulation Annex I
Requirements for Staked Needle Syringes
...
Device Regulation Annex I
Requirements for Staked
Needle Syringes
...
Items In and Out of Scope of TR-73-2,
by Category��������������������������������������������������2

**Table 4.1-1**

Example of MAA Information Summary
...
Example of Device Attributes�����������������������9

**Table 4.2-3**

Example of Device Intended Use and
...
Example of Component Information����������11

**Table 4.4-2**

Example of Functional Unit Information����11

**Table 4.5-1**

Example of Material Information���������������12

**Table 4.5-2**

Example of Materials Relevant in the
Context of GSPR 10������������������������������������13

**Table 4.6-1**

Example of Overview of Packaging
Materials����������������������������������������������������13
...
Supportive Documents Suggested to
Address Relevant GSPRs�����������������������������17

**Table 5.3-1**

Examples of Supportive Documents for
...
Nonapplicable GSPRs and Suggested
Justifications����������������������������������������������32
...
Body (NB) appropriately accredited for the issuance of such an opinion (1) (See Section 3.0).
PDA Technical Report No. 73-2: Application of Medical Device Regulation Annex I Requirements for
Staked Needle Syringes represents the current state of knowledge as to its application. As this is a new
process based on a new regulatory requirement, expectations of the NBs and competent authorities
may diverge as the process evolves. Ultimately, the responsibility for the entire content of the submis-
sion file that is reviewed by the NB lies with the applicant. Accordingly, the intended users of TR-73-2
...
Section 4.0 provides information on documents that provide guidance on completing the NB submis-
sion file. Following MDR Annex II: Technical Documentation to complete the submission file for the
NBs is recommended; individual sections can be written in more or less detail, at the discretion of the
submitting applicant (2). Additional guidance can be found in the Team-NB position papers on docu-
mentation requirements and on best practices for the submission of technical documentation (2,3).
...
technical report. Where a definition is based on another published source, the source is cited. Only defini-
tions that are either not mentioned in TR-73 or not taken from the TR-73 glossary are mentioned here.
...
marketing authorisation application or post-
approval application in the EU (5).
Competent Authorities (National)
A medicines regulatory authority in a European
Union Member State (6).
Container Closure Integrity
Container closure integrity (CCI) is the ability
of a container closure system to maintain the
sterility and product quality of sterile final phar-
maceutical, biological, and vaccine products
throughout their shelf life.
Device Part
A device that fulfills the definition of a medi-
cal device, as defined in the relevant EU legal
...
comes into physical contact with body tissue (7).
...
of the medicinal product is principal (1).
...
would be considered to be a medicinal prod-
uct… [and] if the action of that substance
...
•
If the [medical] device intended to admin-
ister a medicinal product and the medicinal
product is placed on the market in such a
way that they form a single integral prod-
uct which is intended exclusively for use
...
Regulation (EC) No 726/2004, as appli-
cable (Article 1(9), subparagraph 2) (8).
Indirect Contact
...
medical device component itself does not physi-
cally contact body tissue) (7).
...
Member States (adapted from EMA Glossary of
Regulatory Terms) (6).
Nanomaterial
...
terials (Article 2(18)) (1).
Needle Safety Device
A safety feature or mechanism that effectively reduc-
es the risk of an exposure incident (e.g., accidental
needlestick) (9); sharps injuries protection system.
...
allows sterilization of the syringe. The elasto-
meric syringe closure covered by a rigid housing
is called rigid needle shield (10).
Notified Body
...
to facilitate manufacturability, processing, trans-
port, or storage of a material or component. It may
assist in, for example, reducing energy/time/re-
sources required to aid the process, increasing pro-
duction, and cleaning efficiency and machinability.
...
the process clearance capability, may remain as low-
level residuals in the finished component.
Processing Residues
Residues of processing aids in or on the final
drug-device combination.
Quality Certificate
Certificate of Analysis, Certificate of Compli-
ance, or equivalent document providing evi-
dence of compliance with product specifications.
Risk Evaluation
...
evaluating, controlling and monitoring risks (11).
Single-Dose Container
A container that holds a quantity of the prepa-
ration intended for total or partial use on one
occasion only (Ph. Eur. 3.2) (12).
Staked Needle Syringe
Syringe with a needle integrated into the barrel;
the fixation can be done by insert molding, glu-
ing or other bonding methods (13).
...
science, technology and experience (14).
Surgically Invasive
...
body orifice (Annex VIII, Chapt. 1, 2.2) (1).
Syringe Barrel
Cylindrical glass or polymer body with front
end and finger flange (10, 13).
Syringe Components
...
stopper) with lubrication, coating and/or lamina-
tion, plunger rod and, if needed, a backstop.
...
Council Directive 93/42/EEC concerning medical devices. Regulatory changes and updates affect re-
quirements for staked needle PFS that significantly impact global marketing authorization applicants
...
product is governed by the MDR, as opposed to Directive 2001/83/EC relating to medicinal prod-
ucts. MDR Article 1(9), subparagraph 2 states:
However, if a device intended to administer a medicinal product and the medicinal
product are placed on the market in such a way that they form a single integral prod-
...
ion (NBOp), the device part of the PFS must be classified as a “virtual device.” MDR Annex VIII lays out
...
device part, and device and the pharmaceutical company. As the pharmaceutical company (the ap-
plicant) is filing both for the NBOp and the marketing authorization, it is ultimately responsible for
ensuring that all content and data are “attributable, legible, contemporaneous, original and accurate
(ALCOA)” (15). The European Medicines Agency (EMA) provides a comprehensive website, updated
regularly, with questions and answers on good manufacturing practices (GMP) and data integrity (8).
...
Safety and Performance Requirements,” “Benefit-Risk Analysis and Risk Management,” and “Product Verifi-
...
Enterprises and European Federation of Pharmaceutical Industries and Associations (16,17).
...
D084 C52
Indication(s)
As per SmPC1 module 4.1
Marketing Authorisation Holder (MAH)
Name and address of the legal entity holding the Marketing
Authorization or respective EU-authorized representative
...
included, as needed, clearly indicating the components and respective explanations to support under-
...
The level of detail provided by the component manufacturer shall be appropriate to support the phar-
maceutical company in their overall risk evaluation and the derived control strategy. Accordingly, the
...
•
List manufacturing sites(s), test site(s), site responsible for release, and sterilization sites (if ap-
plicable)
•
...
defined by the respective supplier until filling and assembly. All facilities involved in filling and assem-
bly are qualified and perform such functions, for example, as monitoring of temperature, room pres-
sure, and relative humidity. References to storage and transport validation studies performed, as well as
...
should be provided.
For more information, see TR-73, Section 11. 9 “Shelf Life and Storage,” and Section 12.3.5 “Ship-
ping and Distribution of Semifinished Syringes and PFSs.”
...
documents needed.
Throughout the list, different terminology is used, such as file, report, plan, protocol, document, sum-
mary, evidence, or statement. Most terms have slightly different meanings and are used differently
...
Compliance of a DDC, with relevant European Pharmacopoeia (Ph. Eur.) chapter(s) or monograph(s),
...
lubrication, coating, and/or lamination if existing. Content listed here is what the applicant pro-
vides to the NB.
•
...
•	 Risk management file, including
o	 Risk management plan
o	 Hazard identification document
o	 Use-related risk analysis
...
o	 Hazard identification document
o	 Use-related risk analysis
•	 Usability engineering file, including
o	 information for safety, incl. residual risks
o	 intended use, users and context of use information
•	 Evidence of compliance with the applicable parts of GMP requirements
for medicinal products
o	 ISO 14971, ICH Q9
o	 IEC 62366-1
...
•	 Shelf life and storage information
•	 Real-time stability (aging) / accelerated aging studies
summary, e.g., based on
...
•	 Design verification summary report
•	 Traceability matrix
•	 Shipping & transport validation summaries
•	 Evidence of compliance with the applicable parts of GMP requirements
for medicinal products
o	 ICH Q1A
o	 ISO 11040-8
o	 ASTM D4169
o	 ISO 11607-1 (if applicable)
•	 Packaging validation summary
•	 Shelf life and storage information
•	 Real-time stability (aging) / accelerated aging studies
summary, e.g., based on ICH Q1A and/or ASTM F1980
•	 Statements on compliance with the applicable parts of
o	 ISO 11040-4, -6, -7
o	 ASTM D4169
•	 Packaging validation summary
•	 Shelf life/Use-by date and storage information
•	 Real-time stability (aging) / accelerated aging studies
summary, e.g., based on ICH Q1A  and/or ASTM F1980
•	 Statements on compliance with the applicable parts of
o	 ISO 11040-5
...
•	 Usability engineering file, including
o	 Information for safety, incl. residual risks
•	 Evidence for the implementation of a RMS and a usability engineering
process, e.g., according to
o	 ISO 14971, ICH Q9
o	 IEC 62366-1
•	 High-level risk management summary as evidence for the
implementation of a RMS
...
•	 Design verification summary report, incl.
o	 Biological Evaluation report
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products, incl.
–	 Extractables & Leachables
–	 Compatibility
o	 Biocompatibility according to
–	 ISO 10993-1
–	 ISO 11040-8
•	 Evidence of compliance with material safety requirements based on
supplier information
•	 Summary of assessment of
o	 Extractables, incl. ICH Q3D elements
o	 Biocompatibility, based on ISO 10993-1
•	 Statement on REACH
•	 Content declaration on substances of concern, e.g., TSE/
BSE, latex, nitrosamines, CMR/ED, phthalates
•	 Evidence of compliance with Ph. Eur. 3.1.8., 3.2.1, 3.2.2.1,
(3.1.16, 3.1.17, 3.3.9.) 5
...
•	 Summary of assessment of
o	 Extractables, incl. ICH Q3D elements
o	 Biocompatibility, based on ISO 10993-1, USP <87>
•	 Statement on REACH
•	 Content declaration on substances of concern, e.g., TSE/
BSE, latex, nitrosamines, CMR/ED, phthalates
•	 Evidence of compliance with Ph. Eur. 3.1.8., 3.2.9
•	 Typical physical properties
•	 Specification
•	 Quality Certificate
•	 Statements on compliance with the applicable parts of
...
10.1
(b)
Materials, substances, compatibility, material properties
•	 Design verification summary report, incl.
o	 Biological Evaluation report
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products, incl.
...
•	 Summary of assessment of
o	 Extractables, incl. ICH Q3D elements
•	 Biocompatibility, based on ISO 10993-1, USP <87>
•	 Statement on REACH
•	 Content declaration on substances of concern, e.g., TSE/
BSE, latex, nitrosamines, CMR/ED, phthalates
•	 Evidence of compliance with Ph. Eur. 3.1.8., 3.2.9
...
Materials, substances, compatibility, material properties
•	 Risk management file, including
o	 Process risk analysis
•	 Design verification summary report, incl.
o	 Biological Evaluation report
o	 Control strategy
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products
o	 Biocompatibility according to
–	 ISO 10993-1
–	 ISO 11040-8
•	 Evidence for the implementation of a RMS, e.g., according to the
applicable parts of
o	 ISO 14971, ICH Q9
•	 Evidence of compliance with the applicable parts of
o	 ISO 15378
...
o	 ISO 13485
o	 ISO 15378
•	 Process validation summary, incl critical process parameters
•	 High-level risk management summary as evidence for the
implementation of a RMS, incl. critical process parameters
•	 Summary of assessment of
o	 Extractables, incl. ICH Q3D elements
o	 Biocompatibility, based on ISO 10993-1, USP <87>
•	 Evidence for the implementation of a QMS, e.g., according
...
o	 ISO 13485
o	 ISO 15378
•	 Process validation summary, incl. critical process
parameters
•	 High-level risk management summary as evidence for the
implementation of a RMS, incl. critical process parameters
10.1
...
compatibility, material properties
•	 Design verification summary report, incl.
o	 Confirmation of suitability of the materials for the intended use
•	 Evidence of compliance of the material with the required mechanical
properties for the intended use based on supplier information
•	 Specification
•	 Quality Certificate
•	 Statements on compliance with the applicable parts of
o	 ISO 11040-4, -6
...
compatibility, material properties
•	 Design verification summary report, incl.
o	 Confirmation of suitability of materials for the intended use
•	 Evidence of compliance of the material with the required mechanical
properties for the intended use based on supplier information
•	 Evidence of compliance with Ph. Eur. 3.1.8, 3.2.1, 3.2.9
•	 Specification
•	 Quality Certificate
•	 Statements on compliance with the applicable parts of
o	 ISO 11040-4, -6
...
### 10.2 Risks related to contaminants and residues
...
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products
o	 EMA/CHMP/CVMP/QWP/850374/2015
o	 Biocompatibility according to
–	 ISO 10993-1
–	 ISO 11040-8
•	 Evidence for the implementation of a RMS, e.g., according to the
...
o	 Extractables, incl. ICH Q3D elements
o	 Biocompatibility, based on ISO 10993-1
•	 Process validation summary, incl. process residues
•	 Washing and sterilization validation summary
•	 Manufacturing flow chart, incl. critical process steps and
...
o	 Extractables, incl. ICH Q3D elements
o	 Biocompatibility, based on ISO 10993-1, USP <87>
•	 Specification, incl. endotoxins, bioburden, particles
•	 Quality certificate, incl. endotoxins, bioburden, particles
•	 Process validation summary, incl. process residues
•	 Washing and sterilization validation summary
•	 Manufacturing flow chart, incl. critical process steps and
the according controls
...
### 10.3 Use with materials and substances

•	 Risk management file, incl.
o	 Risk management plan
o	 Hazard identification document
o	 Use-related risk analysis
•	 Design verification summary report, incl.
...
applicable parts of
o	 ISO 14971, ICH Q9
•	 Evidence of compliance with the applicable parts of ISO 15378
•	 Evidence of compliance of the material with the required mechanical
properties for the intended use based on supplier information
•	 Summary of assessment of
o	 Extractables, incl. ICH Q3D elements
...
•	 Content declaration on substances of concern, e.g., TSE/
BSE, latex, nitrosamines, CMR/ED, phthalates
•	 Evidence of compliance with Ph. Eur. 3.1.8., 3.2.1.
•	 Statements on compliance with the applicable parts of
o	 ISO 11040-4, -6
o	 ISO 10993-7
o	 EMA/CHMP/CVMP/QWP/850374/2015
...
#### 10.4.1 Risks posed by substances or particles

•	 Risk management file, incl.
o	 Design risk analysis
•	 Design verification summary report, incl.
o	 Biological Evaluation report
o	 Control strategy
•	 Evidence of compliance with the applicable parts of
...
#### 10.4.2 CMR and/or endocrine-

disrupting substances
•	 Not directly applicable (link to GSPR 10.4.1)
•	 If applicable, benefit/risk assessment
•	 Evidence of compliance with material safety requirements based on
supplier information
...
•	 Evidence of compliance with material safety requirements based on
supplier information
•	 Content declaration on phthalates
•	 Content declaration on phthalates

### 10.5 Risks related to unintentional ingress of substances

•	 Risk management file, including
o	 Design risk analysis
•	 Design verification summary report, incl.
o	 Control strategy
o	 Shipping validation
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products
o	 EMA/CHMP/CVMP/QWP/850374/2015 incl. CCI and stability
testing
•	 Evidence for the implementation of a RMS, e.g., according to the
applicable parts of
o	 ISO 14971, ICH Q9
•	 Evidence of compliance with the applicable parts of ISO 15378
•	 For polymer syringes: Permeability studies summary
•	 Statement on compliance with the applicable parts of
o	 ISO 11040-4, -6, incl. Removal force and closure
system/barrel integrity
•	 Information on physical properties, incl. water vapor/
...
### 10.6 Risks related to particles
...
•	 Specification, incl. particles
•	 Quality Certificate
•	 Statement on use of nanomaterials
•	 Statement on compliance with the applicable parts of ISO
11040-4, -6
•	 Specification, incl. particles
•	 Quality Certificate
•	 Statement on use of nanomaterials
...
11.1
(a-d)
Possible risks of infection to patients
•	 Risk management file, incl.
o	 Design risk analysis
•	 Design verification summary report, incl.
o	 Biological Evaluation report
o	 Control strategy
•	 Usability engineering file, incl.
o	 Information for safety, incl. residual risks
o	 Intended use, users, and context of use information
•	 Evidence of compliance with the applicable parts of
o	 GMP requirements for medicinal products
...
o	 ISO 14971, ICH Q9
•	 Evidence of compliance with the applicable parts of ISO 15378
•	 Sterilization validation summary, incl. reference to
applicable parts of
o	 ISO 11040-4, -6, -7
o	 ISO 11135
o	 ISO 11137
...
### 13.2 Devices manufactured utilizing

tissues or cells of animal origin
•	 Evidence of compliance with material safety requirements based on
supplier information
•	 EMA/410/01 Rev. 3
•	 Content declaration on TSE/BSE
•	 Statement on use of substances with animal origin
•	 Content declaration on TSE/BSE
•	 Statement on use of substances with animal origin

### 13.3 Devices manufactured utilizing
...
14.2
(a-g)
Various risk reduction requirements
•	 Risk management file, including
o	 Design risk analysis
•	 Design verification summary report, incl.
o	 Biological Evaluation report
...
•	 Risk management file, including
o	 Design risk analysis
•	 Usability engineering file, including intended use, users and context of
use information
•	 Instructions For Use
•	 Declaration on European Directive 94/62 (EC) on Packaging
and Packaging Waste
•	 Declaration on European Directive 94/62 (EC) on Packaging
and Packaging Waste
20 – Protection Against Mechanical and Thermal Risks

### 20.1 Mechanical risks
...
Syringe Subassembly
Plunger Stoppers
21 – Risks Related to Energy or Substances
22 – Use by Lay Persons

### 22.1 Use by lay persons I

•	 Risk Management File
•	 Usability Engineering File
•	 IFU (or medicinal product PIL whichever is applicable)
•	 Evidence for the implementation of a RMS and a usability engineering
process, e.g., according to
o	 ISO 14971, ICH Q9
o	 IEC 62366-1
...
### 22.2 Use by lay persons II

•	 Risk management file, including
o	 Design risk analysis
•	 Design verification summary report
•	 Usability there is engineering file, including
o	 Information for safety, incl. residual risks
o	 intended use, users and context of use information
•	 Instructions For Use
•	 Not addressable by the component supplier
...
description of the process can be shared, for example, as part of an RM file. ICH Quality Guideline Q9:
Quality Risk Management provides guidance, as does ISO 14971:2019 Medical Devices — Application
of Risk Management to Medical Devices which states:
The risk management file need not physically contain all the records and other documents.
However, it needs to contain at least references or pointers to all required documentation, so
that the manufacturer can assemble the information referenced in the risk management file in
a timely manner. […] The risk management file can be in any form or type of medium. […]
See ISO/TR 24971 for guidance on establishing a risk management file for components and
devices that were designed without using ISO 14971” (11).
Suppliers of components or device parts can support the pharmaceutical company by providing ap-
propriate documentation, which demonstrates a RM process that communicates risks associated with
...
### 5.3 Plunger Rod, Rigid Part of the Rigid Needle Shield and Finger Flange
...
•	 ISO 22442: Medical devices utilizing animal tissues and their derivatives, Parts 1, 2, and 3
•	 Material Safety Data Sheet, Technical Safety Data Sheet
Technical Information and Performance
•	 Detailed technical drawings
•	 Connectivity statement, if applicable (e.g., thread part suitable for 1 mL long plunger with 17 pitch on 25.4 mm)
...
To avoid overloading this document, GSPRs that are not applicable to the DDC in scope of TR-73-2 have not been included. For all nonapplicable GSPRs, provid-
ing a rationale that justifies the decision is recommended. The following suggestions should facilitate development of a justification:
•
...
to be exposed to or used in association with flammable or explosive substances or
substances that could cause combustion.
16 (incl. 16.1-16.4)
Protection against radiation
The device in scope does not emit radiation.
17 (incl. 17.1-17.4)
Electronic programmable systems — devices that incorporate electronic programmable systems and software
that are devices in themselves
The device in scope does not incorporate electronic programmable systems and it is not
software itself.
18 (incl. 18.1-18.8)
Active devices and devices connected to them
The product is not intended to be connected to or equipped with an energy source
other than that generated by the human body for that purpose, or by gravity.
20.6
Accessible parts of devices (excluding the parts or areas intended to supply heat or reach given temperatures)
and their surroundings shall not attain potentially dangerous temperatures under normal conditions of use.
The device is not an active medical device and does not heat.
21.1
Devices for supplying the patient with energy or substances shall be designed and constructed in such a way that
the amount to be delivered can be set and maintained accurately enough to ensure the safety of the patient and
of the user.
The device part does neither supply energy nor substances, as the term is used
throughout MDR. 1
The device part does not have dose setting. One PFS is one dose.
21.2
Devices shall be fitted with the means of preventing and/or indicating any inadequacies in the amount of energy
delivered or substances delivered that could pose a danger. Devices shall incorporate suitable means to prevent,
as far as possible, the accidental release of dangerous levels of energy or substances from an energy and/or
substance source.
The device part supplies neither energy nor substances, as the term is used throughout
MDR.1
21.3
The function of the controls and indicators shall be clearly specified on the devices. Where a device bears
...
Labeling requirements for medical devices/device parts are overruled by
EMA/37991/2019 (Rev.2; section 2.12) labelling requirements for medicinal products.
23.2 f
Information on the label — The label shall bear the following particulars: where applicable, information labeled
...
the Council of 5 April 2017 on Medical De-
vices, amending Directive 2001/83/EC, Regula-
tion (EC) No 178/2002 and Regulation (EC)
No 1223/2009 and repealing Council Direc-
tives 90/385/EEC and 93/42/EEC; Document
32017R0745. OJ L 117: Brussels, 2017.
2.	 The European Association Medical devices
of Notified Bodies. Team-NB Position Paper
on Documentation Requirements for Drug
Device Combination Products Falling in the
Scope of Article 117 of MDR 2017/745;
TEAM-NB.org: Sprimont, Belgium, 2020.
3.	 The European Association Medical devices of
Notified Bodies. Team-NB Position Paper: Best
Practice Guidance for the Submission of Techni-
cal Documentation under Annex II and III of
In Vitro Diagnostic Medical Devices Regulation;
Team-NB: Sprimont, Belgium, 2023.
4.	 European Commission. Directive 2001/83/
EC of the European Parliament and of the
Council of 6 November 2001 on the Com-
munity Code Relating to Medicinal Products
for Human Use; OJ European Commission:
Brussels, 2012.
5.	 European Medicines Agency. Guideline
on Quality Documentation for Medicinal
...
tion. ISO 10993-18:2020/Amd 1:2022:
jBiological Evaluation of Medical Devices —
Part 18: Chemical Characterization of Medical
Device Materials within a Risk Management
Process — Amendment 1: Determination of the
Uncertainty Factor; ISO: Geneva, 2020.
8.	 European Medicines Agency. Questions
and Answers: Good Manufacturing Prac-
tice – Data Integrity. Guidance on good
...
tion. ISO 11040-4:2015 Prefilled Syringes
— Part 4: Glass Barrels for Injectables and
Sterilized Subassembled Syringes Ready for
Filling; ISO: Geneva, 2015.
11.	 International Organization for Standardiza-
tion. ISO 14971:2019 Medical Devices —
Application of Risk Management to Medical
Devices; ISO: Geneva, 2019.
12.	 Council of Europe. European Pharmacopeia
(Ph. Eur.), 11th Edition. Council of Europe:
Strasbourg, 2022.
13.	 International Organization for Standardiza-
tion. ISO 11040-6:2019 Prefilled Syringes
— Part 6: Plastic Barrels for Injectables and
Sterilized Subassembled Syringes Ready for
Filling; ISO: Geneva, 2019.
14.	 Medical Device Coordination Group. Guid-
ance on Standardisation for Medical Devices
(MDCG-5); European Commission: 2021.
15.	 U.S. Food and Drug Administration. Guid-
ance for Industry: Data Integrity and Compli-
ance with cGMP: Questions and Answers;
U.S. Department of Health and Human
Services: Silver Spring, Md., 2018.
16.	 European Biopharmaceutical Enterprises
and European Federation of Pharmaceu-
tical Industries and Associations. EBE-
EFPIA Reflection Paper: Conformity with the
...
and European Federeation of Pharmaceuti-
cal Industries and Associations. EBE-EFPIA
Reflection Paper: An Industry Perspective on
Article 117 of the EU Medical Devices Regu-
lation and the Impact on how Medicines are
Assessed; EFPIA: Brussels, 2018.
18.	 Medical Device Coordination Group.
MDCG 2021-24: Guidance on Classification
of Medical Devices; European Commission:
Strasbourg, 2021.
19.	 European Commission. Guidelines Relating
to the Application of the Council Directive
90/385/EEC on Active Implantable Medi-
cal Devices the Council Directive 93/42/Eec
on Medical Devices: Medical Devices with a
Measuring Function; European Commis-
sion: Brussels, 1998.
20.	 The British Standards Institution. BS EN
60601-1-2:2015+A1:2021 Medical Electri-
cal Equipment General Requirements for Ba-
sic Safety and Essential Performance. Collat-
eral Standard: Electromagnetic Disturbances.
Requirements and Tests; BSI: London, 2021.
21.	 The British Standards Institution. BS EN
62366-1:2015+A1:2020 Medical Devices
Application of Usability Engineering to Medi-
cal; BSI: London, 2020.
22.	 International Organization for Standardiza-
tion. IEC/TR 62366-2:2016 Medical De-
vices — Part 2: Guidance on the Application
of Usability Engineering to Medical Devices;
ISO: Geneva, 2016.
23.	 European Commission. Note for Guidance
on Minimising the Risk of Transmitting Ani-
mal Spongiform Encephalopathy Agents via
...
Advisory Boards are: Science Advisory Board, Advanced Therapy Medicinal Products Advisory Board, Biopharma-
ceutical Advisory Board, and Regulatory Affairs and Quality Advisory Board. Following this stage of review, the
...
Treasurer: Emma Ramnarine, Genentech/Roche
...
Amy McDaniel, BMS
Brigitte Reutter-Haerle, Vetter Pharma International GmbH
Osamu Shirokizawa, Life Scientia, Ltd.
PDA Publication Production and Editing
Josh Eaton, Sr. Director, Scientific & Regulatory Affairs
...
Denyse Baker, Eli Lilly and Company Limited, (Chair)
Eva Urban, CSL Behring AG, (Vice-Chair)
Anette Yan Marcussen, NNE A/S, (Past-Chair)
...
Jacqueline Veivia-Panter, Biocentriq
