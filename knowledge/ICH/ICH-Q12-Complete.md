# ICH Harmonised Guideline Q12 (2019): Technical and Regulatory Considerations for Pharmaceutical Product Lifecycle Management

## 1.0 INTERNATIONAL COUNCIL FOR HARMONISATION OF
...
Date
Q12
Adopted by the Regulatory Members of the ICH
Assembly under Step 4 (document dated 19
November 2019).
20 November
2019
Q12
Endorsement by the ICH Assembly under Step 2
...
Scope ................................................................................................................... 7
1.3
ICH Q12 Regulatory Tools and Enablers ............................................................ 7
CATEGORISATION OF POST-APPROVAL CMC CHANGES .................................. 9
ESTABLISHED CONDITIONS (ECS) ......................................................................... 10
3.1
Introduction ....................................................................................................... 10
3.2
ECs in the Regulatory Submission .................................................................... 10
3.2.1
ECs Definition .................................................................................. 10
...
POST-APPROVAL CHANGE MANAGEMENT PROTOCOL (PACMP) ................. 15
4.1
Definition of a PACMP ..................................................................................... 15
4.2
Application of a PACMP ................................................................................... 15
4.3
Elements of a PACMP ....................................................................................... 16
4.4 Modification to an Approved PACMP .............................................................. 17
4.5
Types of PACMPs ............................................................................................. 17
PRODUCT LIFECYCLE MANAGEMENT (PLCM) DOCUMENT ........................... 18
5.1
PLCM Document:  Scope .................................................................................. 18
5.2
Submitting the PLCM Document ...................................................................... 18
...
MANAGEMENT ........................................................................................................... 19
6.1
PQS General Considerations ............................................................................. 19
6.2 Change Management Across the Supply Chain and Product Lifecycle ............ 20
RELATIONSHIP BETWEEN REGULATORY ASSESSMENT AND INSPECTION 20
...
APPENDIX 2:  PRINCIPLES OF CHANGE MANAGEMENT .......................................... 30
...
lifecycle (i.e., product development, registration and launch).  This guideline addresses
...
involve a regulatory communication, if changed.  This guideline describes how
...
1  For drug substance information incorporated by reference (e.g., a Master File) in an MAA, the holder
...
impact of the change and report any related changes to the approved MAA, as necessary and per
regional requirements.
ICH Q12 Guideline

• Pharmaceutical Quality System (PQS) and Change Management (Chapter 6)
An effective PQS as described in ICH Q10 and compliance with regional GMPs
...
relevant to strategies for confirmatory stability studies to enable more timely
...
Regulatory Assessment and Inspection; however, collaboration and communication
...
with respect to product quality, safety, and efficacy.  A well-characterised, risk-based
...
commercial phase of the pharmaceutical product lifecycle that invoke communication
...
regulatory processes for (a) requesting prior approval from the regulatory authority, (b)
...
immediate notification is useful when prior approval is not required, but timely
awareness of the change by the regulator is considered necessary.
...
approach and a framework that can support additional regulatory opportunities such as:
-
...
defined in this guideline as “Established Conditions for Manufacturing and Control”
...
detail.   Knowledge gained throughout the product lifecycle (including pharmaceutical
...
An MAH should clearly identify the elements of CMC which they consider to be an EC
...
the EC and associated reporting category in line with the principles outlined in Chapter
2.
ICH Q12 Guideline

See Appendix 1 for more information regarding sections of the dossier that contain ECs
and supportive information.  Unless otherwise specified by regulatory requirement
...
(e.g., performance of the container closure system, device elements of drug-device
...
substance and drug product materials and components, facility and equipment operating
...
Process parameters that need to be controlled to ensure that a product of required quality
...
associated with changing the EC, taking into account the overall control strategy
...
assessment can include changes to manufacturing process ECs that range from high to
ICH Q12 Guideline
...
A decision tree which illustrates the above step-wise approach to identifying ECs and
reporting categories for process parameters is shown in Figure 1.  The principles in the
decision tree can be applied to identify ECs for other parts of the manufacturing process
...
development and experience accumulated throughout the product lifecycle) to manage
the risks to product quality.  Different approaches can be used alone, or in combination,
...
between inputs and resulting quality attributes, will include a large
number of inputs (e.g., process parameters and material attributes) along
...
with feedback controls or optimisation algorithms to achieve the relevant targets
for that process step.  When considering this approach, it is important to ensure
that all relevant parameters and material attributes that have a potential to
...
decision tree in Figure 1 apply because the enhanced control strategy used may
...
regarding product-specific post-approval change activities, such as post-change
...
understanding of the relationship between method parameters and method performance,
...
analytical procedures in the MAA.  A suitably detailed description of the analytical
...
marketing authorisation should follow regional expectations.  See Chapter 6 for
information related to interactions between an MAH and any manufacturing
organisations.
For any referenced submission (e.g., Type II Drug Master File, Active Substance
Master File) in an MAA, the holder of the referenced submission has a responsibility
...
describes the CMC change an MAH intends to implement during the commercial phase
...
shortened review period as compared to similar change procedure without an approved
...
one or more changes to be applied to multiple products (see section 4.5).  The PACMP
...
execution of the change, the previously approved reporting category should no longer
...
the change cannot be implemented using this approach and should instead follow
...
justified.
No change outlined in a PACMP should introduce any additional risks to patient safety,
product quality or efficacy.  A CMC change that would require supportive efficacy,
...
new impurities, assessment of immunogenicity/antigenicity) is not suitable for
...
product quality following implementation of the change(s) is required, a
...
Annexes ID and 1E, for content and implementation.  A PACMP can also be
...
If the protocol describes several changes for a particular product, a justification
...
post-approval CMC commitments.  Its purpose is to encourage prospective lifecycle
management planning by the MAH and to facilitate regulatory assessment and
inspection.  The PLCM document should be updated throughout the product lifecycle
as needed.

### 5.1 PLCM Document:  Scope

The PLCM document serves as a central repository in the MAA for ECs and reporting
categories for making changes to ECs. It includes the key elements described below
and references to the related information located elsewhere in the MAA (see Annex IF).
...
in section 5.1, but other appropriate formats can be used. See Annex IF for an example
PLCM table.
ICH Q12 Guideline
...
requirements where the application is filed, is necessary across the entire supply chain
...
process for ECs are illustrated in Figure 2.

*[Figure 2: Connection Between Knowledge Management and Change]*

Management Process

Maintaining an effective PQS is the responsibility of a company (manufacturing sites
and MAH where relevant). It is not the intent of this guideline to require a specific
inspection assessing the state of the PQS before the company can use the principles in
this guideline.   The conduct of inspections in connection with submitted MAAs and
surveillance will nevertheless continue as foreseen by regional regulatory requirements.
...
event that such deficiencies have an impact on the effectiveness of change management
...
manufacturers, Contract Manufacturing Organisations, suppliers).  It is important that
these stakeholders interact to effectively utilise knowledge and manage changes during
the product lifecycle.
A company has to manage communication of information and interactions of PQSs
across multiple entities (internal and external).  Therefore, the implementation of robust
...
management activities should be considered to support the approaches defined in this
guideline:
• Changes to ECs should be communicated in a timely fashion between the MAH
...
to ECs and should be targeted to those entities in the chain that need to be aware
of or to implement the change over the lifecycle of the product.
...
significantly improve control and product consistency.  These data can be
utilised to revise the ECs and associated PLCM document.  The organisation
...
• A critical failure in a PQS anywhere in the supply chain may impact the ability
to use the tools in this guideline; therefore, the company should communicate
such failures to affected regulatory authorities.
...
lifecycle management and the most recent PLCM document, when applicable, should
...
appropriate bilateral/multilateral arrangements; for example, to communicate about
...
exemplified with a description of an approach for analytical procedure changes in
Annex II.  Similar structured approaches could be developed and applied for other
...
as described in Chapter 6 and incorporates an appropriate risk management
system.
• A structured approach can be found in Annex II and describes the scope and the
...
The data needed for submission to the regulatory authority in support of a post-approval
...
included in a PACMP (see Annexes ID and IE).
...
knowledge and experience of the drug product and drug substance acquired since
...
attributes relative to the intended CMC changes, based on risk assessments and
...
CPP
Critical Process Parameter – process parameter
...
Notification
A change to an approved established condition
...
Commitment by the MAH to undertake
specific CMC activities to be implemented
during the commercial phase.
Prior approval
Change to an approved established condition
that requires regulatory review and approval
prior to implementation
PQR
Product Quality Review – regular periodic
...
Submission
Communication to a regulatory authority
...
ICH Q8, Q9, & Q10 Questions and Answers -- Appendix: Q&As from Training Sessions
...
•
White rows indicate CTD sections where ECs are generally located.  Grey rows indicate CTD sections where supportive information
...
3.2.P.3.1
Manufacturer(s)
Drug Product Manufacturing sites (including those for testing, primary and secondary packaging, device assembly for drug
...
change; considers the potential impact if the intended change is not implemented;
...
performance and/or product quality monitoring as necessary;
...
management and change management is illustrated in Figure 2.  These sources can include,
...
manufacturing stakeholders (research and development organisations, manufacturers,
CMOs, suppliers, etc.).
...
the frequency of intended changes that are not approved for implementation by
the quality unit;
