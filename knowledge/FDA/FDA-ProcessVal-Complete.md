...
Systems – Process Validation, edition 2,   See infra note 6.
...
Pharmaceutical Current Good Manufacturing Practice Regulations, available at
...
12 Available at http://www.fda.gov/Drugs/GuidanceComplianceRegulatoryInformation/Guidances/default.htm.
...
parameters, and in-process material quality attributes.  FDA does not generally expect
...
understand the degree to which models represent the commercial process, including any
...
manufacturers should document the variables studied for a unit operation and the rationale for
...
assessments, then enhanced and improved as process experience is gained.
...
Innovative Pharmaceutical Development, Manufacturing, and Quality Assurance.14
...
followed.  Successful completion of Stage 2 is necessary before commercial distribution.15
...
regulations on Buildings and Facilities.  It is essential that activities performed to assure proper
...
• Verifying that utility systems and equipment are built and installed in compliance with
...
Other references that may be useful include ASTM E2474-06 “Standard Practice for Pharmaceutical Process Design
...
15 As discussed in section III of this guidance, process validation (including process qualification) is legally
...
routine production.  It should also include the performance of interventions, stoppage,
...
Qualification activities should be documented and summarized in a report with conclusions that
...
qualification.  The PPQ combines the actual facility, utilities, equipment (each now qualified),
...
Success at this stage signals an important milestone in the product lifecycle.  A manufacturer
...
commercial-scale batches.  Data from laboratory and pilot studies can provide additional
...
relevant studies (e.g., designed experiments; laboratory, pilot, and commercial batches) should
...
objective measures (e.g., statistical metrics) wherever feasible and meaningful to achieve
adequate assurance.
...
monitoring and testing should be sufficient to confirm uniform product quality throughout the
...
re-used without adversely affecting product quality can be assessed in relevant laboratory
...
are designed to measure in real time the attributes of an in-process material and then adjust the
...
validating any manufacturing process is the same:  to establish scientific evidence that the
...
Execution of the PPQ protocol should not begin until the protocol has been reviewed and
...
Out-of-Specification (OOS)Test Results for Pharmaceutical Production, available at
...
conditions established in the protocol and whether the process is considered to be in a
...
market in consideration of the entire compilation of knowledge and information
...
The goal of the third validation stage is continual assurance that the process remains in a state of
...
and data about the performance of the process, will allow detection of undesired process
...
information collected should verify that the quality attributes are being appropriately controlled
...
measuring and evaluating process stability and process capability.18  Procedures should describe
...
Pharmaceutical and Biopharmaceutical Manufacturing Systems and Equipment,” and ASTM E2709-09 “Standard
...
19  Certain manufacturing changes may call for formal notification to the Agency before implementation, as directed
...
such as to manufacture drugs for which there is limited demand (e.g., orphan drugs, minor use
...
for drugs that are medically necessary and are being manufactured in coordination with the
...
process validation is intended to preclude or minimize that outcome.
...
requirements, and PPQ protocol lot release criteria.  Lot release under a PPQ protocol is based
...
taken (§§ 211.100(a), 211.180(e), and 211.192).  We recommend that each batch in a concurrent
...
The degree and type of documentation required by CGMP vary during the validation lifecycle.
...
also useful to generate and preserve process flow diagrams of the various scales as the process
...
examine the quality of drug components, in-process materials, and finished products.  Validated
...
analytical technology and modifications to existing technology are continually being developed
...
Process design:  Defining the commercial manufacturing process based on knowledge gained
...
Production, guidance for industry, October 2006.
...
Good Manufacturing Practice Regulations, guidance for industry, September 2006.
...
FDA/ICH, (CDER and CBER), Q8(R2) Pharmaceutical Development, guidance for industry,
November 2009.
...
ASTM E2474-06 Standard Practice for Pharmaceutical Process Design Utilizing Process
...
ASTM E2500-07 Standard Guide for Specification, Design, and Verification of Pharmaceutical
