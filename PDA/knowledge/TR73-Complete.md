...
# Section 13.0 Manufacturing Requirements (First Half)

    

    

PDA Technical Report No. 73: Prefilled Syringes | p77 - p81

    

## 13.0 Manufacturing Requirements / 13.1 Component Packaging from the Component Manufacturer
...
# Section 13 (Part B): Manufacturing Requirements - Filling, Inspection & Packaging

    

    

PDA Technical Report No. 73: Prefilled Syringes | p82 - p86

## Section 14: Drug Product Compatibility (p87-p95)

# Section 14.0 Drug Product Compatibility (First Half)

    

    

PDA Technical Report No. 73: Prefilled Syringes | p87 - p91
...
# Section 14 (Part 2): Drug Product Compatibility

    

    

PDA Technical Report No. 73: Prefilled Syringes | p92 - p95
...
Injection instructions should call for removal of the needle shield just prior to injection. Needle-shield removal usually leads to the release of a few drops of drug product due to initial vacuum generation followed by positive pressure in the syringes. In cases in which the drug is not injected immediately by the patient after needle-shield removal, there may be a risk that the drug product will dry out on the needle tip leading to clogging of the needle. This risk is higher in drug products that have a high concentration of proteins because these have a greater propensity to become dry. This phenomenon can lead to greater discomfort for the patient because more force to dislodge the clog (or partial clog) in the needle may be required.
            ...
            "For the above-mentioned reasons, it is necessary to characterize the clogging rate of the product as a function of environmental conditions and its impact for the delivery of appropriate patient instructions and training."

## Section 15-18: Appendices (p96-p102)

# Sections 15-18: Appendices I - IV

    

    

PDA Technical Report No. 73: Prefilled Syringes | p96 - p102

    

## 15.0 Appendix I: Electronic Common Technical Document (eCTD) Application Submission Overview
...
| Module | Overview | Proposed Sections |
| --- | --- | --- |
...
| 1 | Administrative information | Cover letter and forms                     Letters of authorization                     Device manufacturer Medical Device Master File (MAF) or 510(k)                     Labeling                     Device index — description of where device content can be found |
            
                
                
            
| 2 | Introduction and overall summaries |
...
| 5 | Clinical | List of clinical studies (module Section 5.2)                     Comparative bioequivalence study reports (module Section 5.3.1.2)                     Reports of postmarketing experience (module Section 5.3.6)                     References (module Section 5.4) |
...
## 16.0 Appendix II: Module 3 for Electronic Common Technical Document (eCTD) Submission Overview
...
| 3.2.P.1 | Description and Composition of the Drug Product                 Describe the device constituent/component(s) (e.g., injector presentation or kit components) in a brief descriptive sentence and include in component table. |
            
                
                ****  

            
| 3.2.P.2.1 | Components of the Drug Product                 No content applicable to devices |
            
                
                ****  

            
| 3.2.P.2.2 | Pharmaceutical Development – Drug Product                 Describe the device constituent/component(s) (e.g., injector presentation) briefly and generally. |
            
                
                ****  

            
| 3.2.P.2.3 | Manufacturing Process Development                 Describe the device constituent/component(s) (e.g., injector presentation) briefly and explain how the manufacturing process or assembly was developed. Cross-reference 3.2.P.3.3. |
            
                
                ****  

            
| 3.2.P.2.4 | Container Closure System                 Provide “suitability” information for the device constituent/component(s). For delivery devices, include a high-level overview of drug-specific data showing that delivery is accurate, 510(k) history, summary of human factors studies of target population, shear studies, component aging, ISO 10993 data, etc. Link to 3.2.R (medical devices). Cross-reference to device master files. |
            
                
                ****  

            
| 3.2.P.2.5 | Microbiological Attributes                 Provide information regarding testing (e.g., development, stability, and shipping studies) to confirm that CCI is maintained. |
            
                
                ****  

            
| 3.2.P.2.6 | Compatibility                 Describe the compatibility of the device with the drug product if there is contact, and provide summaries of compatibility studies if conducted. Include a human factor engineering summary report with a cross-reference to the studies in Section 3.2.P.2. |
            
                
                ****  

            
| 3.2.P.3.1 | Manufacturers                 Provide names and addresses of the sites performing assembly, kitting, or packaging operations. |
            
                
                ****  

            
| 3.2.P.3.3 | Description of Manufacturing Process and Process Controls                 Include a description of the final combination product assembly steps and testing, but not detailed component manufacturing (parts molding or machining). Include hold times, process flow diagrams, assembly or packaging equipment, etc. |
            
                
                ****  

            
| 3.2.P.3.4 | Control of Critical Steps and Intermediates                 For integral combination products, define intermediate checks, in-process controls, and critical process parameters of the manufacturing or assembly process. The content is dependent on product complexity. This section is not applicable to kit components. |
            
                
                ****  

            
| 3.2.P.3.5 | Manufacturing Process Validation and/or Evaluation                 Provide evidence that installation qualification, operational qualification, production qualification (IQ/OQ/PQ) and process validations were completed (e.g., device release test data on multiple representative clinical/stability/commercial lots). |
            
                
                ****  

            
| 3.2.P.5.1 | Specifications                 Provide a table of release specifications for the combination product with limited, key device quality inspection or performance test specifications (ranges). Do not include device component design specifications. |
            
                
                ****  

            
| 3.2.P.5.2 | Analytical Procedures                 Provide an adequate summary of the release test method/protocol for each reported device component specification. |
            
                
                ****  

            
| 3.2.P.5.3 | Validation of Analytical Procedures                 If noncompendial, provide summary validation information (e.g., gauge repeatability and reproducibility [R&R]) with data on measured parameters or cite standards. Descriptive device inspections may not require validation. |
            
                
                ****  

            
| 3.2.P.5.4 | Batch Analysis                 Provide release test results for device characteristics for clinical and/or process validation lots as part of overall combination product batch data. |
            
                
                ****  

            
| 3.2.P.5.6 | Justification of Specifications                 Provide overview of device design inputs that justify specifications (e.g., force to actuate). Supporting design verification data may be necessary. |
            
                
                ****  

            
| 3.2.P.7 | Container Closure System                 Provide a high-level description of device and device components. Link to 3.2.R. Cross-reference to device master file. |
            
                
                ****  

            
| 3.2.P.8.1 | Stability Summary and Conclusion                 Provide a summary of the device constituent aging test program and combination product functional stability test program, stability-indicating parameters, and proposed shelf life for the combination product. Present and discuss stability data. |
            
                
                ****  

            
| 3.2.P.8.2 | Post-approval Stability Protocol and Commitment                 Provide commitments (e.g., annual stability lots) and protocol summaries. |
            
                
                ****  

            
| 3.2.P.8.3 | Stability Data                 Provide functional stability testing data. |
            
                
                ****  

            
| 3.2.A.1 | Facilities and Equipment                 Describe the combination product (final assembly/kitting) facility, flow diagrams, principal equipment, other products, and cross-contamination procedures. |
            
                
                ****  

            
| 3.2.R | Regional Information (medical devices)                 United States: 510(k)-like document for review by the Center for Devices and Radiological Health of FDA; European Union: Technical file-like document for review by notified body or competent authority |
...
| Category | Descriptions of Tests, Standards, and Guidance Documents | Plunger Stopper | Needle | Needle Shield | Assembled Syringe |
| --- | --- | --- | --- | --- | --- |
...
| Sterility | Microbial limits and bioburdens/endotoxins                     21 CFR 610.12                     USP <71> Sterility Tests                     EU Annex 1                     Pharmacopeia European 2.6.1 | • | • | • | • |
...
| Sterilization                     FDA Guidance for Industry - Submission Documentation for Sterilization Process Validation in Applications for Human and Veterinary Drug Products 1994                     USP <1211> Sterilization and Sterility of Compendial Articles                     ISO 11135-1 (2007)                     ISO 11137-1 (2006)                     ISO 11137-2 (2006, revised)                     ISO 11137-3 (2010, revised)                     ISO 11138 (2006)                     ISO 11737-1 (2006)                     ISO 17665-1 (2006)                     ISO 14937 (2009)                     ISO 10993-7 (2008) | • | • | • | • |
...
| Tests, Standards, and Guidance Documents | Assembled Syringe |
| --- | --- |
...
| USP <1207> Sterile Product Packaging — Integrity Evaluation                     FDA Guidance for Industry, Container and Closure System Integrity Testing in Lieu of Sterility Testing as a Component of the Stability Protocol for Sterile Products                     FDA Guidance for Industry, Container Closure Systems for Packaging Human Drugs and Biologic                     ASTM F2338                     ICH Q5C                     EMA, Note for Guidance on Pharmaceutical Development | • |
...
| Sub-category | Tests, Standards, and Guidance Documents | Applicable Components |
| --- | --- | --- |
...
| GlassDimethicone NF | USP <660> Containers — Glass                     Ph.Eur. 2.9.17                     Ph.Eur. 3.1.8                     Ph.Eur. 3.2.1                     ISO 8106 (2004)                     ISO 11040-4 (2007) | Syringe barrel |
...
| Elastomer(plunger stopper and needle shield)Dimethicone NF | USP <381> Elastomeric Closures for Injection                     USP <661> Containers — Plastics                     ISO 8871-1 (2003)                     ISO 8871-2 (2003)                     ISO 8871-4 (2006)                     ISO 8871-5 (2005)                     ISO 11040-5 (2012)                     Ph.Eur. 3.1.8                     Ph.Eur. 3.1.9                     Ph.Eur. 3.2.9 | Plunger stopper, Needle shield |
...
| Needle | ISO 23908 (2011)                     ISO 594-2                     ISO 7864                     ISO 9626 (1991)                     AISI 304                     DIN 13097                     ISO 11608-2 (2012)                     U.S. Congress, Needlestick Safety and Prevention Act                     FDA, Medical Devices with Sharps Injury Prevention Features                     EU, Framework Agreement on Prevention from Sharp Injuries in the Hospital and Health-care Sector | Needle |
...
| General Safety | USP <1031> The Biocompatibility of Materials Used in Drug Containers, Medical Devices and Implants                     USP <87> Biological Reactivity Tests, In Vitro                     USP <88> Biological Reactivity Tests, In Vivo                     ISO 10993 | All components |
...
| Sub-category | Tests, Standards, and Guidance Documents | Plunger Stopper | Needle | Needle Shield | Assembled Syringe |
| --- | --- | --- | --- | --- | --- |
...
| Extractables and Leachables | USP <1663> Extractables Associated with Pharmaceutical Packaging Systems (in development)                     USP <1664> Leachables Threshold and Best Practices (in development) | • | • | • | • |
...
| Sub-category | Tests, Standards, and Guidance Documents | Assembled Syringe |
| --- | --- | --- |
...
| Performance as Combination Product | USP <1> Injections                     Ph.Eur. 2.9.17. Test for Extractable Volume of Parenteral Preparations                     ISO 7864                     ISO 9626                     FDA Guidance documents:                     Medical Device Use-Safety - incorporating HFE into Risk Management                     Draft Guidance for Industry and FDA Staff — Applying Human Factors and Usability Engineering to Optimize Medical Device Design                     Technical Considerations for Pen, Jet, and Related Injectors Intended for Use with Drugs and Biological Products (draft guidance)                     Glass Syringes for Delivering Drug and Biologic Products                     Submissions for Post-approval Modifications to a Combination Product Approved Under a BLA, NDA, or PMA                     ISO Standard:                     ISO 7886-1:1993 Sterile hypodermic syringes for single use — Part 1: Syringes for manual use, Annex C - Method for determination of dead space | • |
...
| General Quality Systems | 21 CFR 210                     21 CFR 211                     21 CFR 610                     21 CFR 820                     ICH Q8                     ICH Q9                     ICH Q10                     ISO 15378 (2006)                     EN ISO 13485 (2003)                     EN ISO 14971 (2007) | • |
...
| Packaging / Shipping | ISO 11607                     ISO 14644-1                     ASTM F88/F88M-09                     ASTM F1929                     ASTM F1980                     ASTM D4169                     ASTM D4728                     ASTM D5276                     ASTM D5487                     ASTM D6653                     ISTA 3 E | • |
...
## 18.0 Appendix IV: Compound Classification with the Associated Threshold of Toxicological Concern (TTC)
...
| Compound ClassPQRI - PODP | Compound Class Details | Suggested TTC |
| --- | --- | --- |
...
| Class I | Cramer Classification – Class I “Low Risk”                     Substances of simple chemical structure with known metabolic pathways and innocuous end products which suggest a low order of oral toxicity | 150 μg/day |
...
| Class II | Cramer Classification – Class II “Medium Risk”                     Substances that are intermediate in toxicity | 45 μg/day |
...
| Class III | Cramer Classification – Class III “High Risk”                     Substances with chemical structures that permit no strong initial impression of safety and may even suggest a significant toxicity                     (Given that no Toxicity alerts are generated for the following toxicological end points: sensitization, irritation, genotoxicity, mutagenicity, carcinogenicity, teratogenicity) | 7.5 μg/day |
            
                ****
                
                ****
            
| Class IV | Sensitizer – irritant – teratogen: compounds suspected of endocrine disruptor activity | 5 μg/day |
...
| Class V | Genotoxin, mutagen, carcinogen                     + Substances of very high concern (e.g., DEHP, bisphenol A) | 1.5 μg/day |