...
## Section 0: Ch1-2: Introduction & Key Concepts (p9-p22)

## Section 1: Ch3-4: Life Cycle Approach & Phases (p23-p48)

# Chapters 3–4: Life Cycle Approach & Life Cycle Phases

    

    

ISPE GAMP 5 Second Edition | p23 – p48

    

## Chapter 3: Life Cycle Approach | 3
...
The computerized system life cycle encompasses all activities from initial concept to retirement. The life cycle for any system consists of four major phases:
...
Suppliers of products and services should be involved as appropriate throughout the life cycle. An inventory of computerized systems should be maintained. A GxP assessment should be performed by the beginning of the project stage to determine whether a system is GxP regulated, and if so, which specific regulations apply.
...
A **linear approach** is particularly suitable when system requirements are fully understood and defined upfront (Figure 3.3). The specification activities have equivalent verification steps to determine whether the specification has been met. A hierarchy of specifications may be required for larger systems, while specifications may be combined for smaller, simpler, or standard systems.
...
Factors for the successful adoption of Agile include:

        

            
- A robust QMS within an appropriate organizational culture

            
- Well-trained and highly disciplined teams following a well-defined process supported by effective tools and automation

            
- Proper customer or product owner involvement

        

        

This Guide describes the overall GxP system life cycle from the perspective of the regulated company and does not define the software development process in detail. While this section provides a suggested approach, it is recognized that other models and approaches are equally acceptable.
...
Regulatory authorities are adopting critical thinking to help determine whether controls are fit for intended use. Practitioners should not consider that the level of regulatory compliance achieved is directly proportionate to the amount of paperwork produced. Too much paperwork can confuse and make it harder to maintain and inspect computerized systems. Regulators look for scaled and targeted activities with well-organized information and records that have an appropriate level of detail, supported by clear and unambiguous rationales explaining the critical thinking applied.
...
An initial risk assessment or GxP assessment should be performed so that GxP regulated systems are identified before the project phase commences.
...
The key supporting processes of risk management, change and configuration management, design review, traceability, and document management also are described in this section. Each project stage typically involves multiple activities.
...
Planning should cover all required activities, responsibilities, procedures, and timelines. As described in Section 2.1.3, life cycle activities should be scaled according to:
...
The extent and detail of requirements gathering and specification should be sufficient to support risk assessment, further specification, development of the system, and verification. Where appropriate, e.g., for process control systems, requirements should be traceable to relevant CPPs and CQAs.
...
Configuration management and version control are intrinsic and vital aspects of controlled configuration and coding. Specifications should be maintained and controlled.
...
The use of effective and appropriate testing tools is encouraged. Such tools should have documented assessments for their adequacy (refer to EU Annex 11 Clause 4.7) and be controlled in use; however, validation is not required.

        

Testing is often performed at several levels depending on the risk, complexity, and novelty. Tests may be defined in one or more test specifications to cover hardware, software, configuration, and acceptance.

        

An appropriate test strategy should be developed based on the risk, complexity, and novelty. Supplier documentation should be assessed and used if suitable. The strategy should define which types of testing are required and the level and purpose of test specifications.
...
This may be a continuously managed process rather than a one-off event, for example Continuous Integration and Continuous Deployment (CI/CD), and Software as a Service (SaaS).
...
**4.2.5.1 Risk Management**  
        ...
        An appropriate risk-management process should be established throughout the project phase.

        

**4.2.5.2 Change and Configuration Management**  

        Appropriate configuration management processes should be established such that a computerized system and all its constituent components can be identified and defined at any point during its life cycle. Change management procedures covering software, hardware, and documentation should be established. Appropriate change processes should be applied to both project and operational phases.

        

**4.2.5.3 Design Review**  

        At suitable stages during the life cycle, planned and systematic design reviews of specifications, design, and development should be performed. This design review process should evaluate deliverables to ensure that they satisfy the specified requirements. The rigor of the design review process and the extent of documentation should be based on risk, complexity, and novelty. Design reviews are mainly applicable for custom applications and within the supplier product development processes.
...
**4.2.5.5 Documentation and Knowledge Management**  

        Management of documentation includes preparation, review, approval, issue, change, withdrawal, and storage. Documentation, tools, and systems contain explicit knowledge that is captured and codified, whereas implied knowledge is context-specific knowledge acquired through personal experience. Both need to be considered for successful initial and subsequent system deployments.
...
#### 4.2.6 Practical Examples — GAMP Categories

        

This section shows how the general approach may be applied in a scalable manner to three common types of systems, using Categorization of software.

        

Computerized systems are generally made up of a combination of components from different GAMP Categories. Categories 3 to 5 should be viewed as a continuum with no absolute boundaries. Table-driven approaches purely based on categorization decisions should be avoided.

        

**4.2.6.1 Category 3 — Standard Product:** Software products used off-the-shelf (not configurable for a specific business process). Approach: one level of specification and verification is typically applicable. Testing typically covers correct installation, tests demonstrating fitness for intended use, and any further tests from risk/supplier assessments.

        

**4.2.6.2 Category 4 — Configured Product:** Commercial software products configured for a specific business process. A flexible approach to specification and verification may be applied. Testing covers correct installation, configuration of the system, functionality supporting the specific business process, and acceptance against requirements. Testing should be focused on the configuration.

        

**4.2.6.3 Category 5 — Custom Application:** Developed to meet individual user requirements where no commercially available solution is suitable. May use linear (waterfall) or Agile methods. Testing covers correct installation, functionality and design, fitness for intended use, and any further tests from risk assessments. Rigorous testing should be performed at both functional and design levels.

## Section 2: Ch5-8: QRM, Regulated Company, Supplier & Efficiency (p49-p84)
...
# Chapters 7–8: Supplier Activities & Efficiency Improvements

    

    

ISPE GAMP 5 Second Edition | doc p69–p84

    

## Chapter 7 — Supplier Activities | 7
...
Although the responsibility for compliance with GxP regulations lies with the regulated company, the supplier may have considerable involvement in the process. Regulated companies may be able to leverage supplier knowledge and documentation, subject to suitability following formal assessment. This may involve an audit, depending on risk, complexity, and novelty.

        

Suppliers provide a range of products, applications, and services for hardware, software, and related technologies including cloud-computing services. The relationship between supplier and regulated company will vary significantly depending upon the product, application, or scope of service being provided. Consultants, for instance those acting as implementation partners, should have sufficient education, training, and experience to advise on the subject for which they are retained.
...
If the product is purchased off-the-shelf and does not require configuration to support business processes, or only offers defined ranges of factory-provided values or ranges (parameterization), supplier involvement with the regulated company is typically limited to the provision of documentation, training, support, and maintenance. The product should be developed and maintained by the supplier in accordance with good practices.
...
If the product requires configuration to support specific business processes, supplier involvement will typically include support with specification, configuration, verification, and operation of the system. Procedures to follow should be agreed between the regulated company and the supplier and be documented in the appropriate plan. Procedures adopted may be those of the regulated company or from the supplier QMS.
...
For a custom application, the regulated company typically contracts a supplier to develop the application based on defined requirements. Therefore, the supplier will be involved during the full project life cycle of the system, and also to provide support during system operation. Procedures to follow should be agreed between the regulated company and the supplier and be documented in the appropriate plan.
...
Suppliers that provide IT/IS services (including cloud-computing services) should operate within a QMS. Quality planning should define the activities, procedures, deliverables, and responsibilities for establishing delivery and monitoring of the service. Such a plan is a contractual document, and as such, should be approved for use by both the supplier and the regulated company.

        

The required information may be satisfactorily covered by other contractual documents such as a service level agreement (SLA), in which case a separate plan would not be required.
...
- The process to understand customer business process needs and capture requirements (including business, quality, and regulatory requirements)

            
- Responsibilities, including clear separation of authority between QA and other groups such as product development, product support, finance, or marketing
...
The QMS should be based on a life cycle concept. There are many equally valid life cycle approaches that may be used by suppliers, including Agile. This Guide does not recommend any particular approach, but rather highlights those activities expected of suppliers to support the regulated company in achieving and maintaining compliance.

        

The QMS should include procedures covering:
...
The QMS should cover the approach to continual improvement. CMMI provides an approach based on a framework for assessing and improving organizational capability and maturity. The use of ITIL for IT service delivery is encouraged. Industry guidance such as ISPE GAMP should be treated as supporting information and should not override the supplier's established QMS.
...
Requirements are captured and defined internally by the supplier (in the case of product development), and/or may be provided by the customer (for a configured product, custom application, or a service). The requirements should define clearly and precisely what the system should do and state any constraints.

        

Requirements should be developed, reviewed, and approved in accordance with the development method implemented by the supplier whether it be linear or iterative. Changes to requirements should be controlled.
...
The supplier should define how the QMS will be implemented for a particular product, application, or service. This should include defining the life cycle model, project organization, activities, procedures, deliverables, and responsibilities for establishing fitness for intended use. The approach may include prototyping or other software development techniques. The role of supplier QA should be clearly defined.

        

These supplier quality requirements may be captured in a separate Quality Plan or other supplier documentation. Quality requirements should be clearly documented, reviewed, approved, accessible, and followed.
...
The aims and objectives of the prototype should be clearly defined, and the prototype evaluated against these to ensure the objectives are met. Prototyping is often used as part of Agile software development where control is achieved through Agile ceremonies (e.g., daily Scrum), control of the sprint backlog, use of tools, and sprint reviews and retrospectives.
...
References to documentation and specifications should not be interpreted as requiring traditional documents, and the maintenance of records in appropriate and effective software tools is encouraged.

        

Functional specifications should clearly and completely describe what the product will do, produced such that objective testing can be subsequently performed. Design specifications should be based on the functional specifications and should be sufficiently detailed so that the product can be developed.

        

Specifications should be reviewed and approved with traceability established between related documents. They should be managed under change control.

        

If the supplier is involved in configuring a product, service, or developing a custom application, the number and level of specifications can vary considerably and should be agreed with the regulated company.
...
For product development, the supplier should test the product in accordance with approved test plans and test specifications. The test specifications, when executed, should demonstrate that all requirements, functionality, and design have been met.

        

This may involve one or many stages of testing depending on the nature of the product:
...
Test records for each stage should be reviewed and approved, and retained for a period defined in the QMS (not to be shorter than the supported lifetime of the current software version). Test failures should be managed in accordance with a formal documented process.

        

If the supplier is involved in configuring a product or developing a custom application, the number and level of test specifications can vary considerably and should be agreed with the regulated company.
...
*Note: Commercial release by a supplier is not a release into the GxP environment, which is a regulated company activity.*
...
The supplier should support and maintain the system in accordance with agreed contracts. Formal procedures should be followed, typically covering:
...
The supplier should manage the replacement or withdrawal of products or service in accordance with a documented process and plans. Sufficient notice of the retirement of a system or version should be given to regulated companies to allow them to plan for their required activities. The supplier also may support the regulated company with the retirement of computerized systems.
...
In this Second Edition of the Guide many examples of efficiency improvements are also discussed in the context of critical thinking.
...
Risk management provides an opportunity to scale life cycle activities. Benefit may also be achieved if organizations use risk assessments as input to decisions to omit or include an activity. Examples of areas where risk assessments may help with scaling include:
...
Similar opportunities exist during system operation:
...
The benefits of risk-based decision-making can be maximized only if the conclusions and decisions can be leveraged. Therefore, there should be a practical, searchable means of access to conclusions and decisions available to those involved in decision-making — e.g., a risk register.

        

The risk-based approach should be focused and resourced for maximum effectiveness and efficiency. Organizations should not invest more effort and time into the risk-management process than is commensurate with the potential impact on patient safety, product quality, and data integrity.
...
Supplier documentation, information, and records should be assessed for content and quality. Regulated company procedures and processes should be flexible regarding acceptable format and structures so that supplier documentation may be leveraged.

        

If inadequacies are found in the supplier quality system, technical capability, or documentation, then the regulated company may choose to manage potential risks by applying specific, targeted additional verification checks or other controls, rather than repeating supplier activities and replicating supplier documentation.

        

The decision and justification to use supplier activities to support verification should be based on the intended use of the system and should be **documented and approved by SMEs, which may include the quality unit**.

        

Suppliers also may have tools or techniques unique to the specification and testing of their product which may be leveraged by the regulated company during specification and testing.
...
Many systems have large amounts of test results available due to suppliers following a QMS independently of a regulated company. On a project, there may be pre-delivery testing, which may include factory acceptance testing (FAT). Wherever possible, regulated companies should clearly communicate to suppliers the testing and document requirements in advance such that supplier test documentation is of the required standard to support compliance activities.

        

Testing also may take place to meet other business or legal requirements, such as HSE, and finance such as SOX. Unnecessary duplication of testing should be avoided.
...
The level and type of testing should be risk-based and based on the nature of the component involved (standard, configurable, or custom). Types of testing include:
...
While user requirements should be verified by the regulated company through installation and acceptance tests demonstrating fitness for intended use, other required tests should be identified based on risk, complexity, and novelty. The regulated company's procedures should allow for the use of such existing test evidence subject to a documented and justified review and approval by an SME.
...
The generation and retention of secondary supporting hard copy or image evidence such as screenshots, in addition to the primary test result or output, is **unnecessary in most cases and does not add value**. It often adds significant cost without associated benefit. Such additional evidence should be generated and maintained only where value-added and necessary for effective testing.

        

Examples where additional test evidence may be useful:

        

            
- Complex results, which may be difficult or time consuming to record manually

            
- When the result is essentially visual or pictorial
...
Test evidence may be retained electronically provided adequate security and retention mechanisms are established. Systems may also have data audit trails or other system logs that capture much of the information traditionally captured by screen prints.
...
- Information required at handover (specification and verification documentation, user and maintenance manuals or guides), or new or updated user procedures

            
- Training needs (user, support, and maintenance)

            
- Clear communication between groups, e.g., with application support and client service groups

            
- The impact on the change-control process to apply during the handover period, when handover is to be phased
...
- Leveraging the risk assessment information from the original project and assessing any new risks introduced by the change to define the strategy for maintaining compliance — including the need for any regression testing
...
- Lack of scalability for minor changes or standard infrastructure components

            
- Failure to execute change management steps in the appropriate sequence

            
- Failure in scheduling or identifying dependencies
...
- Failure to leverage existing documentation for risk assessment, traceability matrices, or protocols

            
- Lack of follow-up processes to close a change record

            
- Independent change processes leading to duplication of effort

            
- Inappropriate application of like-for-like principles in change management
...
- Lack of adequate follow-up after emergency changes
...
It may be difficult to archive data with different retention periods that share the same data structures. It may also be difficult to destroy retained data that is no longer required (to reduce risk exposure and retention costs) where data with different retention periods share the same data structures. A data structure that separates data by retention period can address the requirements of archiving and data destruction, but may involve a complex database design.
...
**Chapter 7** establishes that while GxP compliance responsibility remains with the regulated company, supplier activities can be formally leveraged to reduce the regulated company's validation burden — provided the supplier is properly assessed. The 12-step good practices framework (Table 7.1) defines what a qualified supplier should deliver, from QMS establishment through retirement management.

    

    

**Chapter 8** provides 9 actionable efficiency strategies. The most impactful for resource-constrained CDMOs are: (1) leveraging supplier test evidence with documented justification; (2) eliminating unnecessary screenshots and test witnesses; (3) reusing existing validation documentation for similar systems; and (4) applying risk-based test depth rather than uniform comprehensive testing.
...
- GAMP Category 3/4/5 determines the scope and depth of supplier involvement and regulated company verification obligations.

        
- Sub-supplier management, especially for cloud-hosted GxP data, directly impacts regulated company compliance and must be transparent.

        
- Risk registers should be searchable and reused across projects and change events — not created anew each time.

        
- Commercial release (supplier activity) is entirely separate from GxP release to production (regulated company activity).

        
- Data archiving and migration strategy should be designed at system implementation, not at retirement.

    

⇧

## Section 3: App M1-M4: Validation Planning, Supplier Assessment, QRM & Software Categories (p85-p134)
...
## Section 4: App M5-M12: Design Review, Change Mgmt, IT Infrastructure & Critical Thinking (p135-p182)
...
## Section 5: App D1-D5: Requirements, Configuration, Software Dev & Testing (p183-p234)
...
# Appendices D4 & D5: Software Development & Testing of Computerized Systems

    

    

ISPE GAMP 5, 2nd Edition | Appendices D4–D5 | p207 – p234

    

## D4.1 Introduction & Scope
...
This appendix is not intended to constrain the choice of development methods and models. Suppliers should select and use the most appropriate methods and models for their use. Any examples used, or technologies assumed, are intended to illustrate general principles and are not intended to be restrictive.

        

**Scope:** While the main focus is on software development using high-level and low-level languages, the principles of this appendix also may be applied to various techniques used for process control system software development/configuration.
...
This appendix has been updated in line with changes made to Appendix D1 (Specifying Requirements), and also to align with information in new appendices D8 (Agile) and D9 (Tools).
...
## D4.3.1 Software Development

        

The software development method should be defined and regardless of the model used, should also define:
...
- Configuration and use of build and deployment systems

        

        

Source code should be subject to review with the approach and extent of such reviews based upon the coding language, tools, and risk to patient safety, product quality, and data integrity.

        

#### D4.3.1.1 General Design and Documentation Principles
...
It is good practice to include a **Software Bill of Materials (SBOM)** that provides the list of components/modules that make up the overall software and can also be used to identify/track inter-dependencies.
...
- Be well designed and sufficiently commented

        

        

#### D4.3.1.2 Software Module Identification
...
## D4.3.1.3–1.7 Version Control, Maintainability & Code Quality

        

#### Software Module Change Traceability

        

All software module changes should be clearly identified according to the chosen software development life cycle and technology used. It should be possible to obtain a history of changes made, which should include the following information for each change:
...
#### D4.3.1.5 Open-Source Modules

        

Where modules are imported from an open-source code repository, updates as and when the open-source code is updated need to be determined. In addition, occasionally open-source modules may be retired, in which case future vulnerabilities will not be addressed, which increases risk.

        

#### D4.3.1.6 Removal of Dead Code

        

Dead code is code that cannot be executed due to the logic of the program, and should be removed. It is usually a symptom of poor maintenance. Code that has been included for purposes of testing or for later diagnosis during support work, and which can be configured on or off, is not regarded as dead code.

        

#### D4.3.1.7 Reliability and Error Recovery

        

"Defensive" coding techniques should be employed. Input values should be checked, and subroutines should check that the values of the received parameters are within range. In the event of a failure, a safe, documented error recovery or a controlled shutdown should be performed, with an informative error message.
...
- To ensure that programming standards, such as those described above, are consistently and correctly applied
...
The review should be performed by at least one independent person with sufficient knowledge and expertise, in conjunction with the author of the code.
...
#### D4.3.2.1 Static Analysis of Software

        

"Static analysis involves a set of methods, supported by tools, used to analyze software source code or object code to determine how the software functions and establish criteria to check its correctness."
...
A decision based upon known risks should determine the extent of software review required for a given project. The criteria for making this assessment, and the outcome, should be documented.
...
If a decision is taken to use OSS, then such software should be implemented in accordance with the appropriate life cycle activities as for commercial software, with consideration of the following:

        

            
- Knowing the size and sustainability of the open-source community

            
- Checking for development standards and good documentation

            
- Knowing what version is in use — verify download from a reputable source and ensure code was not altered (via checksum)

            
- Understanding the governance model for updates and patches

            
- Keeping up-to-date with patches and updates; vulnerabilities are often exposed in software using outdated versions of open-source libraries
...
This appendix covers the testing of GxP computerized systems. It is not intended to offer a prescriptive approach — it does not require that testing must be done a certain way in a particular sequence. Instead, this appendix identifies the influences on testing and offers information on the types of testing and testing approaches that can be used selectively and in combination for optimal assurance that the system is fit for its intended use.
...
#### Key Changes from GAMP 5 First Edition

        

            
- Critical thinking should be applied when planning testing efforts such that the level of effort is commensurate to the risk acceptable within the organization

            
- Testing by any means and in any part of the life cycle all contributes to finding defects and confirming fitness for intended use

            
- Testing should not be limited to detailed and prescriptive step-by-step scripted protocols. Exploratory testing and other unscripted techniques are encouraged

            
- Modern approaches may rely on records and artifacts in automated tools in place of formal specification and test documentation — either approach is acceptable
...
## D5.3 Roles and Responsibilities
...
## D5.4 Influences on Test Activities & Table 25.1

        

Test coverage and approaches are influenced by the:

        

            
- Criticality of the business process supported by the system, including the GxP impact
...
## D5.9.1.1 Installation Qualification (IQ) Context for Computerized Systems

        

Although the term is not used in this Guide (which refers to "installation verification activities" in general), many companies still use the traditional process validation term **Installation Qualification (IQ)**.

        

The purpose is to verify and document that system components are combined and installed in accordance with specifications, supplier documentation, and local and global requirements. Installation testing provides a verified configuration baseline for subsequent verification and validation activities, and verifies any installation methods, tools, or scripts used.

        

For cloud-native or virtualized software, the use of automated installers combined with configuration management tools and service management tools will be more effective than conventional installation approaches. If they provide dashboard functionality, then a review-by-exception approach can replace many of the static verification activities.

        

Whatever the approach, the availability of appropriate technical information should be verified. Examples include:

        

            
- User and technical guides; SOPs; Training schedules

            
- SLAs; Security procedures; Log books

            
- Hardware inventory; Instrument lists; Specification sheets

            
- Certificates and calibration procedures

            
- Software inventory (including installation procedure, system software list, application software list, data list, initial data settings)

            
- Preventive maintenance program; List of critical spare parts
...
## D5.5 Test Planning/Coverage & Test Cases

        

#### D5.5.1 Test Management Processes

        

Early and efficient testing, during development as well as during the verification phase, improves defect detection and reduces the occurrence of defects surviving into the operational phase.
...
#### D5.5.2 Scripted vs. Unscripted Testing — Table 25.2 Summary
...
The identity of the tester should be recorded for all executed test cases. It is disproportionate and unnecessary to use test witnessing or to require the tester to initial every test step.

        

Automated test tools require a documented assessment of their adequacy prior to use.

        

#### Test Evidence — Critical Thinking

        

It is recommended to apply critical thinking when defining the need for test records and evidence:

        

            
- Ensure that even where testing is not scripted in detail, the objective of the test remains clear, and the results record adequately what testing was carried out
...
- Adopt an **exception-reporting approach**: if the system response matches expected results, a simple "Pass" can be recorded. If the system responds unexpectedly, record both a "Fail" and a description of how the response differed

            
- Recognize that routine requirements for screenshots as objective evidence bring little value to verification activities

        

        

## D5.5.4 Reviewing and Reporting Completed Tests

        

Completed testing should be reviewed to verify that the computerized system is fit for its intended use. While test evidence should be reviewed to confirm completeness and accuracy, there is little value in:
...
Unusual patterns of test failures associated with particular authors and/or individual testers should be investigated to determine whether there are any wider testing implications.
...
## D5.6 Types of Testing

        

#### D5.6.1 Test Types Unique to Unscripted Testing

        

            
- **Ad-hoc testing** — unscripted testing performed without planning or predefined documentation. Aimed at finding defects as early as possible.

            
- **Error guessing** — a testing technique designed to expose anticipated and potential defects based on the specialist tester's knowledge and experience of failure modes.

            
- **Exploratory testing** — experience-based testing where the tester spontaneously designs and executes tests based on existing specialist knowledge, prior exploration, and typical common software behaviors and types of failure and defects.

            
- **Day in the life testing** — allows users of the system to carry out their normal day-to-day activities to uncover issues not identified by scripted testing. These testers need real-life business process experience and knowledge.

        

        

#### D5.6.2 Other Test Types (Scripted or Unscripted)

        

            
- **White box testing** (structural testing) — test cases identified based on the internal structure (source code) of the component or system.

            
- **Black box testing** (functional testing) — based on an analysis of the specification, without reference to internal structure.

            
- **Normal Case testing** — challenges the system's ability to do what it should do, including triggering alerts and error messages per specifications.

            
- **Negative Case testing** — challenges the system's ability to correctly prevent actions that specifications state should be prohibited or blocked.

            
- **Repeatability testing** — challenges the system's ability to repeatedly do what it should.

            
- **Performance testing** — challenges the system's ability to perform as fast and effectively as required by specifications.

            
- **Volume/Load testing** — challenges the system's ability to manage high loads. Typically automated. Required when system resources are critical.

            
- **Structural/Path testing** — challenges a program's internal structure by exercising detailed program code.

            
- **Smoke testing** — superficial testing to check critical functionality as a measure of system build stability.

            
- **Regression testing** — challenges the system's ability to still do what it should after being modified; verifies that portions not involved in the change were not adversely affected.

        

        

#### D5.6.3 Contractual/Acceptance Testing: FAT and SAT

        

Acceptance tests are a predefined set of functional tests that demonstrate fitness for intended use. Acceptance may be carried out in two stages:

        

            
- **Factory Acceptance Tests (FAT)** — performed at the supplier site before delivery to show that the system is working well enough to be installed and tested on-site.

            
- **Site Acceptance Tests (SAT)** — show that the system is working in its operational environment and that it interfaces correctly with other systems and peripherals.
...
- **Formal testing environment** — dedicated environment for structured validation testing

            
- **Operational environment** — the target production environment

        

        

The use of multiple environments provides the opportunity to:

        

            
- Assess changes before they are rolled out to production

            
- Provide a target for restore testing of backup data

            
- Reduce risk to the live operational environment and data

        

        

The DevOps environment used in Agile approaches may be replicated into multiple test environments on demand. The test environments, whether on-premise or hosted by the SaaS provider, need to be **functionally equivalent** for the testing to be representative and effective. Differences should be assessed and mitigated.

        

It is essential that a record is kept of the environment in which a test case was run, and the **current build and configuration of that environment**. This record may reside in an automated tool (e.g., continuous integration orchestration).
...
It is the scope, rigor, and coverage of the testing that ensures the quality of the system as implemented. Any significant differences between the environments used for testing should be assessed to determine the equivalency of test results.
...
## D5.8 Leveraging Previous Testing Including Supplier Testing

        

#### D5.8.1 Supplier Testing
...
- **Acceptance Testing for Purchased Hardware and Software** — subject to acceptance testing before being used for the system's development

            
- **Unit/Module Tests** — stand-alone tests for software components, ensuring readiness for further integration
...
- The extent, coverage and quality of the supplier testing

            
- How supplier test records can be made available for appropriate assessment and review
...
#### D5.8.2 Ongoing Life Cycle Maintenance

        

New releases of the software by the supplier will result in the need for the regulated company to actively maintain the validated state after upgrading. Critical thinking and risk management should be used to determine the extent of the effort required.

        

As a minimum, the regulated company will need to verify the updated software remains fit for their intended use. The supplier should provide a clear understanding of the changes being implemented. Regression testing of the configuration and workflows — whether manual or automated — may be implemented to confirm the latest software version still provides a system fit for the regulated company's intended use.

        

#### D5.8.3 Testing in Multiple Environments

        

Testing in environments other than the validation or production environment contributes to finding defects and confirming the system is fit for intended use. Where there is no impact to the particular test types arising from the difference in the environments, the testing should be leveraged no matter what environment it occurred in — there is no benefit to repeating that testing in the formal test or production environments.
...
## D5.9 Testing Applied to Different Software Categories

        

#### D5.9.1.2 Points to Consider for All Systems

        

This is an aide memoire only and does not replace the need to apply critical thinking and a risk-based approach. Test coverage may include:

        

            
- Power failure testing — prevention against loss of critical data; ease of controlled restart

            
- System access and security features

            
- Data audit trails for creation, modification, and deletion of GxP records
...
- Transfer of critical data into other packages or systems
...
#### D5.9.2 Category 3: Standard Product Testing

        

Software products used off-the-shelf (not configurable, or limited parameterization). Testing should focus on:
...
- Requirements testing that demonstrates fitness for intended use (may include testing against requirements depending on risk)

            
- For very simple measurement systems, regular calibration may substitute for testing
...
#### D5.9.3 Category 4: Configured Functionality Testing

        

Commercially available software configured for a specific business process. Testing should focus on:
...
- **Configuration testing** — verifying that the system has been configured in accordance with the agreed specification

            
- **Functional testing** — challenging functionality supporting the specific business process based on risk and supplier assessments

            
- **Requirements testing** — challenging the configuration and user-defined workflows to ensure business process needs have been met

        

        

#### D5.9.4 Category 5: Custom Application Testing

        

Custom-developed software. Testing should include Category 4 approaches, plus:
...
- **Software module testing** — testing software modules defined in the design specification

            
- **Software integration testing** — testing that the modules work when operating together
...
## Section Summary — Appendices D4 & D5
...
- **D4 Software Development**: GxP software must follow a defined development lifecycle with version control, code review, and release criteria. SBOM is a new best practice for tracking software components and dependencies.

                
- **Code Review**: Source code review has three objectives — verify coding standards, verify design compliance, and identify defects. Review must be performed by an independent person. Static analysis tools can complement manual review.

                
- **D5 Test Strategy**: Risk-based approach is mandatory. Not all functions require the same depth of testing. Critical thinking must be documented.

                
- **IQ/OQ/PQ in CSV**: IQ verifies correct installation and configuration baseline. OQ tests all configured functions against FRS. PQ uses real-world end-to-end scenarios by business users to confirm fitness for intended use.

                
- **Scripted vs Unscripted**: Both are valid. Scripted testing is pre-approved and provides the basis for regression testing. Unscripted testing (exploratory, day-in-the-life) improves defect detection. Unscripted does NOT mean undocumented.

                
- **Defect Management**: Critical defects require fix before go-live. Major defects may allow conditional release with documented workarounds and QA-approved risk assessment. Minor defects can be deferred with documentation.

                
- **Regression Testing**: After software updates, determine test scope by: supplier release notes, impact assessment on GxP functions, and risk-based decision on which tests to re-run.

                
- **Test Environment**: A separate validated test environment is essential. It must be functionally equivalent to production. Record the environment version for every test execution. Testing in other environments (dev, supplier) can be leveraged if equivalency is assessed.
...
## Section 6: App D6-D11: System Descriptions, Agile, Blockchain & AI/ML (p235-p280)

# GAMP 5 (2nd Ed.) — Appendices D6–D9: System Descriptions, Data Migration, Agile Development & Software Tools

    

    

ISPE GAMP 5 Second Edition | Appendix D6–D9 | p235–p256
...
This appendix provides guidance on the contents of System Descriptions. EU GMP Annex 11 requires that there is an up-to-date description of critical GxP regulated computerized systems:
...
The need for a system description may be covered by one or more existing specifications or other documents, or a separate document may be produced. The principal use of such a document is to help new users and regulators understand what the system does, and as such is written in non-technical language as far as possible.
...
The system description should be maintained up-to-date throughout the life cycle of the system. For complex systems spanning multiple departments or sites (e.g., ERP systems), a separate document may be appropriate. For simpler systems it is common practice to include the system description in another specification or other document.
...
Listed below are topics that may be required in the system description depending on the nature and type of system. The guidance is neither prescriptive nor exhaustive. The system description should cover only the main features — detailed information on specific topics should be included in other specifications and not repeated.
...
This should explain the context of the system within the business process and regulated company in general, considered from the following perspectives as appropriate:
...
A description of the key functions of the system, both GxP and non-GxP. The functions may be grouped to maintain the description at a high level. The use of diagrams is encouraged to explain relationships between key functions.
...
An indication of the main hardware and software components should be provided. This may include servers and storage devices, operating systems, databases, and application layers, plus references to configuration documentation. A detailed inventory of all components is not required here.
...
An overview of the key interfaces to other systems and equipment, and the data flowing to or from the system.
...
An overview of the access control features of the system, both physical (if relevant) and logical.
...
An overview of the established system security controls both physical and logical, including software for the protection of data and records (e.g., virus protection software).
...
Definitions of any terms that may be unfamiliar to the readership should be provided.
...
This appendix provides guidance for the migration of electronic data in the regulated environment, covering planning, execution, and reporting. Migration activities should be focused on aspects critical to patient safety, product quality, and data integrity, commensurate with risk, complexity, and novelty.
...
Data migration is the activity of transporting electronic data and associated metadata from one system to another, or the transition of data from one state to another. Data migration can occur often during and/or at the end of the life cycle of various computerized systems. Migration efforts can vary greatly in scope, complexity, and risk, including:
...
- Same system – different platform migration (e.g., on-premise to cloud)
...
The ultimate goal of any data migration is to have data that **remains usable and retains its contextual meaning**. Quality management controls should be in place to ensure data migration efforts are successful, compliant, and repeatable. Each data migration should be managed within the framework of a data migration plan and report, or through following an established data migration procedure.
...
Data migration may take place multiple times during the life cycle of a single computerized system, such as during initial system development and deployment, application upgrades, and system retirement. A data migration SOP may be the best method for describing and documenting the process expectations, including quality and compliance requirements. It must utilize a risk-based approach to ensure the effort is appropriately rightsized.
...
The following should be evaluated when migrating regulated data:

        

            
- The inherent quality and compliance risk associated with the data being migrated, including impact upon patient safety, product quality, and data integrity; risk associated with the business processes; and risk associated with incomplete source data
...
- Risks associated with the use of system vendors and third-party contractors
...
Migration of electronic data in the regulated environment should be performed under change control. All appropriate data migration project documents and tools should be controlled using configuration management and good documentation practices, including ALCOA+ principles.

        

During a data migration project, system changes unrelated to the migration should be prohibited, as unrelated system changes can increase complexity and overall project risk.

        

Typical good practice is to use one or more intermediate staging areas for data extracted from source systems prior to being loaded into the target system. At least three system platforms should remain under configuration management during the entire project: the source system(s), the staging area, and the target system. A rollback strategy should be established, including a full source-system backup prior to any migration activities.
...
Data migration efforts typically involve software tools to automate extraction, transformation, loading, and verification activities. These tend to be GAMP software Category 1 infrastructure tools or Category 5 custom applications. The infrastructure tools and custom applications should be fit for intended use. For software tools that move or transform data, there are three principal areas of risk:

        

            
- Data will be moved or transformed incorrectly or incompletely (incorrect data format, accuracy and/or completeness of the information, loss of information, orphan records)

            
- Data residing in the target system will be harmed (deletion and/or overwriting of data, breaking and/or modification of data links, loss of metadata)

            
- In cases where not all data is being migrated, residual data in the source system is adversely affected by the removal of the migrated data

        

        

Through the use of data verification, these risks can be significantly mitigated and therefore the rigor of software migration tool verification can be reduced. Development and approval of a data mapping table is still necessary.
...
Data should be verified each time it is moved or its state is transformed. There are two general types of post-migration data verification:

        

            
- **Test environment verification:** A target test system is initially populated with data, then a migration test run is performed, and finally data is verified to show that all required data migrated successfully. A typical approach is to work with a relatively small amount of data, which can then be completely verified.

            
- **Operational environment verification:** The same intent but the amount of data is typically very large. Automated software tools can be used to verify 100% of data in the target environment.

        

        

An important part is confirming that **all of the required data has been migrated**. Verification techniques such as checksum can be used to corroborate complete data transmission and locate failed records. Objective evidence of data verification should be generated.
...
The reliability of the source-system data must be considered as part of the migration process. If the reliability of the source system and data are unknown, the veracity of data migrated from the source system may not be verifiable; additionally, the migrated data will mix with reliable data already in the controlled target system. If inconsistencies are possible, they should be documented with justification of why the migrated data should be trusted.
...
- Separate migration of metadata or configuration may also be required (e.g., user groups and access rights)

            
- Need for multiple migrations through various versions of a system to ensure full compatibility in the final target system
...
Audit trails can be problematic for data migration efforts. If the target system has an audit trail but the source system does not, documentation should be created reflecting that auditing for migrated records began when they were loaded onto the target system. If both the source and target systems have audit trails and it is technically feasible, the audit trail should be migrated along with the audited data. If technically unfeasible, the original audit trail should be archived in a format that can be retrieved and used for support or investigational purposes.

        

When possible, a computer-generated audit trail should be created during the movement and transformation activities associated with the data migration effort. If the audit trail must be turned off during migration, the rationale should be documented.
...
System vendors and third-party vendors should be assessed/audited to ensure they are capable of performing the work and that tools utilized are validated for their intended use. Master Service Agreements (MSAs), SLAs, Statements of Work (SOW), and/or quality agreements should be established.
...
Every data migration project should have a data migration plan as a required deliverable. The data migration plan should describe the entire migration process, including as a minimum:
...
- Configuration management strategy (source, staging, and target environments)
...
- Cutover plan (including communication activities)
...
The data migration report summarizes the activities conducted during the data migration effort. It describes any anomalies or deviations encountered and lists the results of verification activities. Because the report will be used to establish the reliability of the migrated data, it should clearly state the overall outcome of the migration activity (e.g., full success, partial success, failure). The data migration report should be approved by the same individuals who approved the migration plan.
...
FDA's Technology Modernization Action Plan (TMAP) identified Agile software development and DevOps as foundational requirements for a modern FDA technology infrastructure. Such approaches are very well suited to the development of GxP regulated systems if correctly applied by trained and qualified practitioners supported by appropriate tools.

        

This appendix provides a summary of the principles underpinning Agile and illustrates how it can be implemented in a way that is aligned with GAMP 5 and GxP principles. The focus is on how to use well-implemented standard Agile processes to deliver software for GxP applications — it does not advocate modifying Agile for GxP (e.g., by superimposing linear V-model activities).

        

The planning, specification, verification and reporting activities within this Guide are not inherently linear, and the approach described is designed to be compatible with a wide range of models, methods, and schemes including incremental, iterative, and exploratory models.

        

The key principles behind Agile software development are that of discovery and of iteration (ongoing changes) as opposed to waterfall software development, where there is a linear flow of defining all requirements before transforming them into a complete set of specifications that are then configured/coded before testing commences.

        

#### Agile Manifesto Statements
...
These principles need to be taken in the context of emphasis rather than a binary choice.
...
Agile software practices can be applied across many types of computerized systems, including custom application development and configuration of configurable products in an incremental manner. Where the regulated company is looking at less clearly defined scope/requirements, Agile is likely to be the preferred approach to commence with a discovery phase to develop the initial backlog requirements and enable faster initial system deployment and subsequent incremental development.
...
#### 28.3.1 Agile Basics (Scrum Framework)

        

There are many different frameworks for Agile; the popular Scrum framework will be used as the reference. Agile is not a reason to accept a lower level of quality or GxP compliance. Evidence of fitness for intended use may be generated and maintained in tools and supporting systems, rather than in traditional documentation.
...
- The Scrum cross-functional team takes a subset of the backlog items and develops/delivers and tests these during a sprint.

            
- A sprint retrospective evaluates the business value of the completed sprint, and drives continuous improvement.
...
Sprints are governed by time and designed to be a short period, 2 to 4 weeks. Backlog items unable to be completed during the Sprint return to the backlog.

        

Regulated company quality roles typically provide oversight and subject matter expertise on regulations and potential areas of product quality, patient safety, and regulated data impact. Ultimate accountability for quality and compliance lies with the regulated company.

        

The concepts of a Definition of Ready (DoR), Definition of Done (DoD), and also a Minimum Viable Product (MVP) are used to determine activities to be completed before a requirement can be considered complete and to define the minimum set of features needed for initial release.

        

Due to the iterative nature of Agile software development, regression testing, often performed using automated test tools, is typically applied to ensure stability of the system within sprints.
...
With Agile, by planning and storing requirements differently and following Agile principles, teams can successfully deliver effective and useful software in a controlled way that is compliant with GxP regulations, with a clearly identifiable set of fulfilled requirements at the point the system is released into the live GxP operational environment. The delivered description of system functionality is provided by the list of completed Agile artifacts such as epics and user stories obtainable directly from the Agile software development tools.
...
A shift in culture and behaviors is required, according to the following principles:
...
There is a misconception that approval means sign, and by extension that there is the need to comply with the life-sciences regulatory requirements on electronic signatures (e.g., 21 CFR Part 11). This is not the case for software life cycle deliverables (except for SaMD or software embedded in a regulated medical device). Approval can be achieved by many other means such as status change, email, audit trails, and in many cases evidence of acceptance rather than an approval is sufficient.

        

Modern tool sets frequently have immutable change logs built into them, recording exactly who did what and when against each product backlog item, and can be configured to enforce security rights.
...
DevOps is an extension of Agile where the development and maintenance activities are combined within a single team. In a DevOps environment, systems will undergo many changes/releases. This concern can be mitigated with the level of control and oversight of the process. However, there is still a level of risk/impact assessment required for higher-risk GxP functions undergoing change.

        

Continuous Integration (CI) and Continuous Deployment (CD) is an extension of DevOps where there is increased use/reliance on automated software analysis tools. DevOps provides additional controls such as:
...
- Source code review and automated testing as part of the CI process

            
- Ensuring close alignment and constant engagement with the product owner
...
By following the agreed Agile process and associated ceremonies, a state of control can be demonstrated and quality built into the product. User stories can be assessed against INVEST criteria:
...
A typical GxP regulated system has functional requirements that have GxP impact along with nonfunctional requirements (e.g., security) that need to be in place to support GxP regulations including data integrity. There must be a "potentially shippable product at the end of each sprint" — an untested product is not shippable. Agile testing uses a combination of exploratory testing and test automation with regression testing to verify that sprint developments do not impact correct functioning of software developed in previous sprints.

        

Agile is by its essence about tightly controlled management of change. Adherence to the defined Agile process (Scrum ceremonies such as sprint planning, daily meetings, sprint reviews, and sprint retrospectives) drives quality, ensures timelines can be adjusted quickly, and provides a focus on learning by addressing issues as they appear.
...
The tools described in this appendix are GAMP software Category 1. Classification as GAMP software Category 3–5 applies only to business applications (either GxP or non-GxP). Tools, like systems supporting IT processes and infrastructure, are all GAMP software Category 1 and should be managed through the application of good IT practices, within a defined IT management framework such as ITIL.
...
EU GMP Annex 11 requires that automated testing tools and test environments should have documented assessments for their adequacy, supported by appropriate controls following good IT practices.
...
This appendix applies to software tools used as part of software development, support, and maintenance activities. It does not apply to software components/applications that are part of a GxP regulated business process, or can directly impact GxP data/records directly supporting the product life cycle; in this case risk-based computerized system validation is required.

        

For example: software used to migrate or convert GxP records would require computerized system validation; however, a tool used to mask or obfuscate data to be used as system test data would not.

        

Test tools perform an important role by helping to assure thorough testing. Such tools also often store the associated test results, but even though these records may support the computerized system life cycle, the test tools themselves do not require validation. The records they maintain should be preserved and protected, and the tools need to work reliably — this can be achieved through a basic risk assessment and application of normal IT practices.
...
Some basic assessments should be performed as part of tool selection. The key criteria are whether the tool is the appropriate tool to support the life cycle process we are trying to automate/support: does it meet the need of the SMEs who are going to use the tool, and is it fit for purpose? It is not envisaged that any tool would need to have anything other than a desktop assessment, unless the use was considered business critical.
...
- For automated tools, how are any alerts monitored and acted upon?
...
As part of good practice, it is sensible to have some form of inventory, for example within a Configuration Management Database (CMDB), of what tools are used by the organization, where they are deployed, and the nature of any data/records potentially supporting GxP and required retention period. Identifying a single point of contact/owner for the tools is also recommended.
...
Tools typically have a defined lifetime, upgrades, and eventually are retired and/or decommissioned. One person or role should be designated to be the owner of the tool to provide the required level of oversight. In general, tools that have the ability to impact system or network performance require more oversight than those used as part of software development activities. It is best practice to ensure tools in use are at versions supported by the supplier.
...
Cybersecurity considerations should be included for tools. Tools that are deployed across the network (e.g., for performance monitoring) may require more detailed security analysis. Security considerations should be included as part of the initial risk assessment and also as part of the life cycle management (e.g., ensuring tools are maintained as patched and up-to-date). Access privileges for tools should be set as low as possible to allow the tool to perform the task.
...
Where tools are storing information/records that support the validated status of the system (e.g., system requirements, design, code, or test results), controls for maintaining integrity, security, and availability should be determined and applied. Note that increasingly tools and the records/data within them may be cloud-based, and therefore assuring data integrity and access throughout the retention period should take account of this.

        

The full set of data integrity controls that would be applied to primary GxP records are not required, as these tools do not maintain GxP regulated records. Most tools do support technical and transactional logging supporting integrity and investigations.
...
For tools within the scope of this appendix, any approvals or acceptances associated with the tool are not subject to regulated electronic signature requirements. Where an approval or acceptance is required, there needs to be traceability to the person approving or accepting, and approval roles need to be defined.
...
There may be a temptation, particularly where tools store test execution records, to export information into controlled GxP documentation when there is no quality benefit in doing so. This approach is not recommended — it is inefficient and there is the risk that documentation becomes out of step with the information/records within the tools. Tools should have sufficient controls to preserve the data/records.

        

There is the potential for regulatory inspections to request access to information in tools (e.g., system requirements, test results). Process owners need to be aware of what information relating to their computerized system life cycle activities is managed within tools. It may be possible to pre-configure reports to extract test results relating to areas of GxP functionality.
...
Appendices D6–D9 of GAMP 5 (2nd Edition) address four practical topics that bridge the gap between theoretical GxP compliance requirements and modern software engineering practice.

    

        
- **D6 System Descriptions** — A regulatory-facing document required by EU GMP Annex 11 for critical systems. It serves as the "passport" of a computerized system, describing its purpose, architecture, interfaces, access controls, and electronic records in non-technical language. Must be subject to change control and periodic review; must be complete before system goes live.

        
- **D7 Data Migration** — One of the most underestimated validation activities. GAMP 5 requires a formal data migration plan (including data mapping, staging architecture, verification strategy, rollback plan) and report approved by QA, process owner, and SMEs. Three-environment staging (source → staging → target) under configuration management is standard good practice. Source data reliability, audit trail continuity, and tool fitness for use are key risk areas.

        
- **D8 Agile Software Development** — Agile (Scrum-based) development is fully compatible with GxP compliance when correctly applied. Evidence of compliance lives in tools (backlog, test management, code repository) rather than traditional document stacks. Key governance mechanisms: Definition of Done, sprint testing (including regression), sprint ceremonies, and INVEST-quality user stories. DevOps/CI/CD adds further automation and control. Quality is built in throughout the process, not bolted on at the end.

        
- **D9 Software Tools** — Development tools (backlog managers, test runners, code repositories, monitoring tools) are GAMP Category 1 and do not require computerized system validation. However, they need risk assessment, adequacy evaluation (EU GMP Annex 11 requirement), designated owners, CMDB inventory, and appropriate controls for any records they hold. The key decision point: does the tool's output constitute a primary GxP record directly supporting the product life cycle? If yes → validation required. If no → risk-based IT good practice suffices.
...
# Appendices D10 & D11: Distributed Ledger Systems (Blockchain) & Artificial Intelligence / Machine Learning

    

    

ISPE GAMP 5 Second Edition | Appendix D10 (p257–p268) & Appendix D11 (p269–p279)

    

## 30.1 What Is Blockchain? Core Technology Concepts

        

A distributed ledger (blockchain) is a shared, cryptographically secured record of transactions maintained simultaneously across many independent nodes. Each new block of records is cryptographically linked to the preceding block, creating a chain that is practically immutable: altering any historical record would require re-computing every subsequent block across the majority of the network.

        

The core properties that make blockchain relevant to GxP applications are:

        

            
- **Immutability:** Once a transaction is written and confirmed, it cannot be changed without network-wide consensus — making fraudulent modification computationally improbable.

            
- **Attributability:** Every transaction is signed by a cryptographic key (blockchain address/wallet), providing a clear record of who performed which action.

            
- **Transparency:** All participants with access can audit the full transaction history.

            
- **Decentralization:** When a network is sufficiently decentralized there are enough independent node operators to make it improbable that any single entity holds undue influence over the core protocol.
...
A typical blockchain deployment in pharma involves multiple layers:

            

                
- **Layer 1 (Core Protocol):** The underlying blockchain network (e.g., Ethereum, Hyperledger Fabric). Changes require majority node consensus.

                
- **Layer 2 / Off-chain systems:** Ancillary systems (ERP, MES, LIMS) that feed data to the blockchain via APIs. GxP controls must be applied to these as well as the blockchain itself.

                
- **Smart Contracts:** Self-executing code deployed on-chain that automates actions when defined conditions are met — analogous to PLC logic trees in manufacturing.

                
- **Off-chain data storage:** Most data is stored off-chain (for cost and privacy); the on-chain record typically holds a cryptographic hash that links to and validates the off-chain data.
...
#### Governance of Public Networks

            

Core protocol updates require coordination of the majority of network operators. When a significant update is not universally adopted, the network may "fork" into two separate chains. Organizations must track these changes and assess the GxP impact of updating — or choosing not to update — their connected systems.

            

There is no preventive mechanism to stop an entity from posting inaccurate data. However, because blockchains are ecosystem-level systems, sustained falsification would require collusion across many independent parties — making it inherently more secure than a single centralized repository.
...
## 30.2 Pharmaceutical Applications of Blockchain

        

### Supply Chain Serialization and Traceability

        

Blockchain's most mature pharma application is cross-enterprise product traceability. A serialized medicine can be represented as a token on-chain with an associated hash of its data attributes (GTIN, lot number, expiry, serial number). Any supply chain participant can verify the token's integrity by re-hashing the off-chain metadata and comparing the result.

        

            

#### Illustrative Token Example (from GAMP 5)

            

```
Serialized product attributes:
  GTIN (01): 00855245005019
  EXP  (17): 112023
  LOT  (10): XYZ123
  S/N  (21): 447018182632

On-chain token ID (random, privacy-preserving):
  0x778gha0ca303305a92d8d028704d65e4942b7ccc9a999164cf

tokenURI hash (SHA-256 multihash):
  1220D5CC15B22D5606BF3DC255979552A4214E29054CD2E60A1446FE570F53F18C6B

Verification: Re-hash source attributes → compare to on-chain hash → if equal, data integrity confirmed.
```
...
### Batch Record Integrity and Data Management

        

Blockchains are generally not the *source of origin* for manufacturing data (that remains in MES, LIMS, ERP). Rather, the blockchain serves as the **source of truth** — an immutable index that links records, timestamps, and transaction evidence across multiple enterprise systems.

        

Data-quality controls must be in place to keep blockchain records in sync with source systems. If off-chain data is corrected for a legitimate reason (error correction, lab OOS investigation), the on-chain hash reference may become invalid and must be updated accordingly.

        

### GxP Controls Required for Blockchain Systems

        

Four control categories must be addressed in any blockchain GxP validation:

        

            
- **Input Controls:** Integrity of data posted to the blockchain; events that trigger transactions; API transformation integrity

            
- **Output Controls:** Accuracy of data extracted from the blockchain; completeness of queries; detectability of skipped transactions

            
- **Processing Controls:** API monitoring; change control for protocol updates; failed transaction monitoring; network stability

            
- **Access Controls:** Who controls which blockchain addresses; authentication before posting; private key custody; smart contract permission management
...
## 30.3 Validation Life Cycle for Blockchain Systems
...
Blockchains are ecosystem-level networks. From the start, external stakeholders must be involved. Business-process mapping during the concept phase should document:

        

            
- The intended use of the blockchain solution and which use cases are GxP

            
- Ancillary systems (ERP, MES, LIMS) that push and pull data to/from the blockchain

            
- High-level risks to patient safety, product quality, and data integrity

            
- Business logic within smart contracts (if applicable)

            
- Data being managed across the network: on-chain, off-chain, metadata

            
- Type of blockchain protocol and associated special considerations

        

        

Creating a swim-lane diagram across all integrated systems helps identify high-risk integration points and interface dependencies — particularly where APIs or smart contracts connect the blockchain to regulated systems.

        

### 30.3.2 Project Phase — Data and Process-Driven Approach

        

The blockchain is likely to serve as a backbone connecting multiple data sources and, in many cases, becoming the **source of truth**. However, the blockchain is generally not the *source of origin* for new data other than identifiers and timestamps.

        

Key project phase steps include:

        

            
1. Map data from source of origin, source of truth, and ownership perspectives

            
2. Identify the resulting controls (Input / Output / Processing / Access)

            
3. Perform risk assessment of business-process logic and data flows

            
4. Plan change management for the full GxP use case
...
Change management must cover the entirety of the GxP use case. For public networks, core protocol changes are managed by the open-source community — the organization must track these and assess the GxP impact. Composable smart contracts (DApps) create a network of dependencies; each component must be assessed for its upgrade governance.

        

### 30.3.3 Retirement and Migration

        

Most blockchains are designed for high availability in perpetuity, but networks may become stagnant. Regulatory data-retention requirements must be met even if the network is abandoned. Strategies include:

        

            
- Maintaining a full node of the retired network until data-retention period expires

            
- Anchoring the final block hash in another secure location

            
- Adopting a "cryptographic agility" approach to evolve with changing security standards

        

        

Migration to a new blockchain protocol presents unique challenges: historical transactions cannot be recreated with original ordering, and wallet addresses are protocol-specific and cannot be directly mapped across chains.
...
#### Source of OriginvsSource of Truth
...
## 30.4 Emerging Technology Considerations & Regulatory Status

        

### 30.4.1 Maturity Evaluation Criteria
...
Blockchain security relies on two cryptographic principles:

        

            
- **Hash functions:** Easy to compute forward, computationally intensive to reverse — linking blocks and providing data integrity verification

            
- **Asymmetric encryption:** Private key creates signatures; public key verifies them — enabling attribution without revealing the private key

        

        

            "From this perspective the validation strategy for the source system may be focused more on data quality than data integrity. While an in-depth understanding of the mathematics and cryptography may not be required, organizations should check that generally accepted or well-known algorithms are used."
              
*— ISPE GAMP 5 Second Edition, Appendix D10, §30.4.2*
        

        

### 30.4.3–30.4.4 Cryptocurrencies and Privacy

        

Public networks require transaction fees paid in cryptocurrency — creating financial and operational risks (account balance depletion, value volatility). Organizations should evaluate Layer-2 solutions carefully, as they inherit but do not fully replicate Layer-1 security.

        

Privacy on public blockchains remains a significant challenge: by design, all transactions are visible to network participants. Zero-knowledge proofs, optimistic roll-ups, and other privacy-preserving technologies are evolving rapidly but carry their own maturity and assessment requirements.

        

### Current Regulatory Guidance Gap

        

Standards for GxP blockchain systems are still emerging, largely driven by industry practice rather than regulatory mandate at the time of publication. The regulatory position on whether blockchain records satisfy the requirements of 21 CFR Part 11 (FDA) or EU Annex 11 remains under active discussion. Organizations are advised to apply conservative, risk-based validation approaches while engaging with ISPE GAMP Communities of Practice for evolving guidance.
...
## 31.1–31.2 Introduction and Scope

        

Artificial Intelligence (AI) and Machine Learning (ML) are transforming how the life sciences industry processes data and automates functions previously performed by humans. As datasets grow and computing power expands, AI becomes capable of making robust decisions in domains previously requiring expert human judgment.

        

This appendix applies specifically to the ML sub-system or component — typically embedded within a wider IT system or application — and provides a life cycle framework for its development, validation, and ongoing management within a GxP regulated environment. This is a *new appendix* in the GAMP 5 Second Edition (no equivalent in the First Edition).

        

The appendix addresses four themes:

        

            
- A basic understanding of AI and static/dynamic ML sub-systems

            
- A risk-based regulatory compliant AI/ML life cycle framework aligned with GAMP 5 phases

            
- The importance of data integrity to AI/ML quality

            
- The iterative nature of AI/ML development and its implications for validation
...
### Static vs. Dynamic ML Systems

        

A critical GxP distinction is whether an AI/ML system is **static** or **dynamic**:

        

            
- Static ML (offline learning): The model is trained once, frozen, and deployed. Changes require formal change management — treated similarly to traditional software changes.

            
- Dynamic ML (online/continuous learning): The model continuously updates its parameters as new data arrives during operation. This creates a unique validation challenge: the model you validated at time T is no longer the same model at time T+6 months.
...
## 31.3.1–31.3.2 Life Cycle: Concept Phase

        

The AI/ML life cycle follows the GAMP 5 framework of Concept → Project → Operation → Retirement, but with critical differences. Most importantly, **data management must begin in the concept phase** because data is the primary resource required for ML — unlike traditional software where data considerations can be deferred.

        

### 31.3.2 Concept Phase Activities

        

The concept phase must address five primary principles before any data collection begins:

        

            
- **Transparency:** How will the model behave? Can its reasoning be explained?

            
- **Reproducibility:** Can outcomes be reliably replicated under the same conditions?

            
- **Interpretability:** What factors drive the model's outputs?

            
- **Applicability:** How and where will the model be applied? What are the boundaries of use?

            
- **Liability:** Who is ultimately accountable for model decisions?
...
Data can be acquired from internal sources (data warehouses, MES historians, LIMS) or external sources (open-source datasets, purchased datasets). Key selection considerations:
...
- **Privacy and controls:** Data classification, GDPR/PII compliance, use rights

            
- **Structure/format:** Unstructured, semi-structured, or structured

            
- **Segmentation:** Clustering, priority tiers, necessary vs. nice-to-have

        

        

Data must be partitioned into **training, validation, and test sets** during the concept phase — and this partitioning must be maintained throughout development to prevent data contamination that would compromise unbiased model evaluation.

        

### 31.3.2.3 Data Preprocessing and Classification

        

Data preparation includes: profiling and formatting, cleansing and transformation, anonymization (for GDPR compliance), and augmentation for diversity. The quality and integrity of data is critical — the quality of output is determined by the quality of input. Preparation must be documented and performed by data scientists with domain expertise.

        

            "The quality and integrity of the data is critical (the quality of output is determined by the quality of input) and must be suitably classified and labeled. This is one of the most time-consuming efforts in the process."
              
*— ISPE GAMP 5 Second Edition, Appendix D11, §31.3.2.3*
...
## 31.3.3 Life Cycle: Project Phase — Model Development

        

The project phase follows an **iterative and incremental** approach — not the linear waterfall model familiar from traditional computerized system validation. Each iteration cycles through: model design/selection → engineering → training → evaluation → hyperparameter tuning.
...
Initial requirements define the functionality and performance expectations of the ML sub-system. Performance metrics are a key component — they serve as the technical specifications for model acceptability and drive the iterative training-evaluation cycle. Nonfunctional requirements (deployment constraints, integration, security) must also be defined early to inform algorithm selection.
...
A ML model is selected based on the question it is expected to answer. For a new system, it is unlikely that the algorithm choice is clear-cut from the start. Candidate algorithms should be evaluated against operational, performance, and regulatory requirements through a structured prototyping process.

        

### 31.3.3.3–31.3.3.4 Model Engineering and Training

        

Model engineering involves constructing architectures and surrounding infrastructure for training and hyperparameter tuning. During training:

        

            
- The training dataset is supplied to the model; output is compared to ground truth to measure performance and update model parameters

            
- The validation dataset evaluates training quality and assists in fine-tuning — it does NOT act as the final acceptance test

            
- Hyperparameter optimization can be manual or automated (e.g., Bayesian optimization), but data scientists should not take a completely hands-off approach

            
- Bias due to non-representative training data is a significant risk and must be actively managed

        

        

### 31.3.3.5 Model Evaluation and Testing

        

The best-performing models from training iterations are evaluated using performance scorecards. Visual qualitative evaluation of validation results — not just quantitative metrics — often yields better insights into failure modes. When target performance is achieved, models are selected as candidates for deployment.

        

### 31.3.3.6 Integration and Deployment

        

The ML sub-system is migrated from development code (optimized for fast prototyping) to deployment code (optimized for production maintenance). Key architectural principle: **modularization** — the inference module (forward pass from input to output) is isolated from training, evaluation, and parameter-update code.
...
The test dataset — excluded from all training and validation activities to date — is used as an independent dataset to confirm acceptable performance within the overarching application's UAT prior to deployment. At minimum, the verification process must be specified and documented, resulting in formal release of the first AI/ML sub-system version.
...
## 31.3.4 Life Cycle: Operation Phase — Monitoring & Continuous Evaluation

        

The operation phase is where AI/ML systems diverge most significantly from traditional computerized systems. The performance of the AI/ML sub-system must be **continuously monitored and maintained**.

        

### 31.3.4.1 Monitoring for Static Systems

        

For static systems, changes must follow the organization's formal change-management process with risk-based evaluation of impact on current and future production data, and robust testing before deployment.

        

### 31.3.4.1 Monitoring for Dynamic Systems

        

For dynamic systems, appropriate KPIs and acceptable tolerance limits must be established to ensure the algorithm is still operating as intended. A systematic approach to integrating additional training data must be maintained:

        

            
1. Acquire additional data of the needed sub-class

            
2. Assign a portion to training set; exclude the remainder for testing

            
3. Retrain model on augmented training dataset (expect possible performance drop due to increased challenge)

            
4. Evaluate revised model against original model on augmented test dataset

            
5. Confirm revised model achieves acceptable performance level before deployment
...
In the operational phase, it is possible to integrate and prepare new data to further refine existing models, develop new predictive models, and establish performance monitoring to track ongoing effectiveness. Quality control standards and measures must exist to ensure acceptable performance throughout the model's usable life.
...
*— ISPE GAMP 5 Second Edition, Appendix D11, §31.3.5.1*
...
## 31.3.5 Supporting Processes: Risk Management, Data Governance & Change Management
...
Risk management drives the process and controls needed for AI/ML systems. The risk framework must address both the traditional risks of the original process AND the additional risks introduced by ML intervention. Key risk considerations include:

        

            
- Use of external vendors and data suppliers

            
- Retaining sufficient technical and scientific knowledge within the organization

            
- Model maturity and extent of previous real-world use

            
- Changes to production data and/or errant (corrupted) input data

            
- System performance, downtime, and business continuity

        

        

For **static ML sub-systems** where all data acquisition and annotation are supervised and validated prior to inclusion, standard data validation and change-management processes are generally sufficient.

        

For **dynamic ML sub-systems** — including online learning with continuous model parameter updates — additional controls are required: continual and robust performance evaluation, defined acceptance criteria for ongoing model changes, and heightened monitoring.

        

In all cases, **periodic review** is needed to identify bias, overfitting, and performance degradation. Review frequency may be determined by time interval or by activity triggers such as incorporation of new case data.
...
Data governance is critical to the success of ML. Not all data is created equal. The governance strategy must address:

        

            
- Data size, quality, and prevalence — what volume is sufficient for training?

            
- Whether a separate data-acquisition project is needed before model development begins

            
- Format specification, annotation tools, and cleanup processes

            
- How ground-truth data is generated, validated, and maintained

        

        

For image-based tasks (e.g., visual inspection), ground truth is produced by expert labeling — a time-intensive process that requires people with both technical and domain expertise.
...
Change management integrates data controls into system responses and processes to maintain ongoing control. Drivers of change in AI/ML systems include:

        

            
- **Performance Requirements:** Changes to improve performance — may trigger model retraining on existing datasets

            
- **Additional Inputs:** Changes to case data or algorithms to expand compatibility and increase generalization

            
- **Intended Use:** Changes to the significance of information or the clinical/manufacturing context

        

        

User stories and system controls, along with human intervention as a check, are effective starting points for designing the change-management workflow. Visual process maps with scenarios and mitigations help identify weak points.
...
## 31.4 Regulatory Perspectives on AI/ML in Pharma Manufacturing

        

The regulatory framework for AI/ML in pharmaceutical manufacturing is actively evolving. GAMP 5 Appendix D11 references the **Joint US FDA/Health Canada/UK MHRA Good Machine Learning Practice (GMLP) for Medical Device Development: Guiding Principles** — currently the most comprehensive regulatory framework directly applicable to AI/ML in regulated environments.
...
The FDA's action plan for AI/ML-based Software as a Medical Device (SaMD) acknowledges that traditional pre-market testing cannot fully address the unique nature of continuously learning AI systems. The regulatory challenge is that a model validated at time of approval may legitimately change over time through continued learning — raising questions about re-validation triggers.

        

Current industry consensus positions:

        

            
- Any significant model change (performance shift beyond defined tolerance, change in intended use, change in training data scope) should trigger a formal change assessment

            
- Pre-defined performance monitoring plans with explicit alert thresholds should be part of the validation package

            
- Transparency reporting to regulators for significant post-deployment model changes is emerging as expected practice
...
Current regulatory guidance universally maintains that for GxP-critical decisions, AI should **assist** human judgment, not replace it. Automated AI-driven decisions in GxP-critical processes (batch release, OOS investigation conclusions) remain a high regulatory risk without explicit guidance permitting them. Decisions must be attributable to qualified human reviewers who can evaluate and accept or override AI-generated recommendations.
...
#### Appendix D10 — Blockchain () Key Takeaways

            

                
- Blockchain provides cryptographic immutability for transaction records — but cannot guarantee the accuracy of data initially posted; input controls remain critical.

                
- The blockchain is typically the *source of truth*, not the *source of origin*; all source systems (MES, LIMS) must maintain ALCOA+ compliance.

                
- Four control categories are required: Input / Output / Processing / Access — with particular attention to API integrity and private key management.

                
- Smart contracts must undergo code review and change management as GxP software components.

                
- Regulatory guidance on whether blockchain records satisfy 21 CFR Part 11 / EU Annex 11 is still evolving — conservative validation approaches and industry engagement (ISPE GAMP CoP) are recommended.

                
- Technology maturity evaluation (network age, developer community, change governance) is essential before selecting a blockchain platform for GxP use.
...
#### Appendix D11 — AI/ML Key Takeaways

            

                
- AI/ML introduces a fundamentally different validation challenge: dynamic models change as they learn — validation must be ongoing, not a one-time activity.

                
- Data is the primary asset in AI/ML: GIGO applies — data governance (classification, labeling, partitioning, provenance) is as important as algorithm selection.

                
- Dataset partitioning into training / validation / test sets must be established and maintained from the concept phase — data contamination undermines all subsequent validation.

                
- Model drift (gradual performance degradation) requires continuous KPI monitoring with pre-defined tolerance limits and periodic review triggers.

                
- For GxP-critical decisions, AI must assist, not replace, qualified human judgment — "human in the loop" remains the regulatory baseline.

                
- Start AI/ML programs with non-GxP-critical applications (predictive maintenance, EM trend analysis) to build validation competency before expanding to GxP-critical use cases.
...
#### Shared Theme: Risk-Based Validation in the Age of Emerging Technologies

            

Both blockchain and AI/ML represent cases where traditional SDLC and validation frameworks must be applied with adaptation. GAMP 5 2nd Edition's core message: the principles remain the same (risk-based, life-cycle approach, patient-centered), but their application must evolve with the technology.

            

For both technologies, the concept phase is disproportionately important — decisions made about governance, data architecture, and system boundaries at the start determine whether GxP compliance is achievable at all.
...
## Section 7: App O1-O13: Operation Appendices (Handover, CAPA, Security, Archiving) (p281-p346)
...
## Section 8: App S1-S6 + G1-G2: Special Topics, References & Glossary (p347-p404)
...
# Appendices G1–G2: References & Glossary

    

    

ISPE GAMP 5, 2nd Edition | p383–p404 | Section 08b

    

## Appendix G1 — References / G1
...
1. 1.**ISO 9000 Quality Management series**, International Organization for Standardization (ISO), www.iso.org.

            
2. 2.**ISO 14971:2019** Medical devices — Application of risk management to medical devices, ISO, www.iso.org.

            
3. 7.**International Organization for Standardization (ISO)**, www.iso.org.

            
4. 16.**ISO 13485:2016** Medical devices — Quality management systems — Requirements for regulatory purposes, ISO, www.iso.org.

            
5. 17.**ISO 14971:2019** Medical devices — Application of risk management to medical devices, ISO, www.iso.org.

            
6. 39.**ISO 9001:2015** Quality management systems — Requirements, ISO, www.iso.org.

            
7. 43.**ISO 19011:2018** Guidelines for auditing management systems, ISO, www.iso.org.

            
8. 44.**ISO/IEC 27001:2013** Information technology — Security techniques — Information security management systems — Requirements, ISO/IEC, www.iso.org.

            
9. 45.**ISO/IEC DIS 27002** Information security, cybersecurity and privacy protection — Information security controls, ISO, www.iso.org.

            
10. 46.**ISO/IEC 27017:2015** Information technology — Code of practice for information security controls based on ISO/IEC 27002 for cloud services, ISO/IEC, www.iso.org.

            
11. 47.**ISO/IEC 20000-1:2018** Information technology — Service management — Part 1: Service management system requirements, ISO/IEC JTC1, www.iso.org.

            
12. 66.**ISO/IEC/IEEE 90003:2018** Software engineering — Guidelines for the application of ISO 9001:2015 to computer software, ISO/IEC, www.iso.org.

            
13. 82.**ISO/IEC 27701:2019** Security techniques — Extension to ISO/IEC 27001 and 27002 for privacy information management, ISO/IEC, www.iso.org.

            
14. 85.**ANSI/ISA-88.00.01-2010** Batch Control Part 1: Models and Terminology, ANSI, www.ansi.org.

            
15. 97.**ISO/IEC TR 13066-3:2012** Information technology — Interoperability with assistive technology (AT) — Part 3: IAccessible2 API, ISO/IEC, www.iso.org.

            
16. 99.**ISO/IEC 27031:2011** Information technology — Security techniques — Guidelines for ICT readiness for business continuity, ISO/IEC, www.iso.org.

            
17. 102.**ISO/IEC/IEEE 24765:2017** Systems and software engineering — Vocabulary, ISO, www.iso.org.

            
18. 105.**ISO 22966:2009** Execution of concrete structures, ISO, www.iso.org.

            
19. 106.**ISO/IEC TR 25051:2015** Software engineering — Systems and software Quality Requirements and Evaluation (SQuaRE) — Requirements for quality of Ready to Use Software Product (RUSP), ISO/IEC, www.iso.org.
...
1. 6.**International Council for Harmonisation (ICH)**, www.ich.org.

            
2. 14.**ICH Q9** — Quality Risk Management, Step 4, 9 November 2005, www.ich.org.

            
3. 21.**ICH Q10** — Pharmaceutical Quality System, Step 4, 4 June 2008, www.ich.org.

            
4. 84.**ICH Q8(R2)** — Pharmaceutical Development, Step 5, August 2009, www.ich.org.

            
5. 100.**ICH Q7/Q7A** — Good Manufacturing Practice Guide for Active Pharmaceutical Ingredients, Step 4, 10 November 2000, www.ich.org.

        

        

US FDA Regulations & Guidance

        

            
1. 23.**Federal Food, Drug, and Cosmetic Act (FD&C Act)**, US FDA, www.fda.gov.

            
2. 24.**Public Health Service Act**, Title 42 of the United States Code, Chapter 6A, www.ecfr.gov.

            
3. 25.**United States Food & Drug Administration (FDA)**, www.fda.gov.

            
4. 29.**Prescription Drug Marketing Act of 1987**; Prescription Drug Amendments of 1992, Effective date: 4 December 2000, www.ecfr.gov.

            
5. 33.**General Principles of Software Validation; Final Guidance for Industry and FDA Staff**, US FDA, 11 January 2002, www.fda.gov.

            
6. 53.**21 CFR Part 211.188** — Current Good Manufacturing Practice for Finished Pharmaceuticals: Batch production and control records, FDA, www.fda.gov.

            
7. 69.**FDA Technology Modernization Action Plan (TMAP)**, September 2019, www.fda.gov.

            
8. 73.**21 CFR Part 11** — Electronic Records; Electronic Signatures, Code of Federal Regulations, US FDA, www.fda.gov.

            
9. 75.**Modernization in Action 2022**, TMAP and DMAP Anniversary Report, FDA, www.fda.gov.

            
10. 78.**Good Machine Learning Practice for Medical Device Development: Guiding Principles**, October 2021, US FDA, Health Canada, MHRA, www.fda.gov.

            
11. 87.**21 CFR Part 211.186** — Current Good Manufacturing Practice for Finished Pharmaceuticals: Master production and control records, FDA, www.fda.gov.

            
12. 94.**FDA Guidance for Industry: Data Integrity and Compliance with CGMP, Questions and Answers**, December 2018, www.fda.gov.

            
13. 101.Office of Regulatory Affairs, **"Glossary of Computer System Software Development Terminology (8/95)"**, FDA, November 2014, www.fda.gov.

            
14. 104.**FDA Guidance for Industry: Process Validation: General Principles and Practices**, January 2011, www.fda.gov.
...
1. 26.**European Medicines Agency (EMA)**, www.ema.europa.eu/en.

            
2. 32.**EudraLex Volume 4, Annex 11: Computerized Systems**, June 2011, http://ec.europa.eu/health/documents/eudralex/vol-4/index_en.htm.

            
3. 59.**EudraLex Volume 4, Chapter 7 — Outsourced Activities**, January 2013, http://ec.europa.eu/health/documents/eudralex/vol-4/index_en.htm.

            
4. 60.EMA, **"Q&A: Good Clinical Practice (GCP)"**, European Medicines Agency (EMA), www.ema.europa.eu.

            
5. 79.**GDPR — Regulation (EU) 2016/679** on the protection of natural persons with regard to the processing of personal data, https://gdpr-info.eu.

            
6. 88.**EudraLex Volume 4, Chapter 4: Documentation**, January 2011, http://ec.europa.eu/health/documents/eudralex/vol-4/index_en.htm.

            
7. 95.**EudraLex Volume 4, Annex 16: Certification by a Qualified Person and Batch Release**, October 2015, http://ec.europa.eu/health/documents/eudralex/vol-4/index_en.htm.

            
8. 103.EMA, **Guideline on Good Pharmacovigilance Practices (GVP), Annex I — Definitions (Rev 4)**, EMA/876333/2011 Rev 4, www.ema.europa.eu.

        

        

ISPE Guidelines & GAMP Good Practice Guides

        

            
1. 10.**ISPE Good Practice Guide: Knowledge Management in the Pharmaceutical Industry**, First Edition, May 2021, www.ispe.org.

            
2. 15.**ISPE GAMP Good Practice Guide Series**, www.ispe.org.

            
3. 20.**ISPE GAMP Good Practice Guide: Enabling Innovation — Critical Thinking, Agile, IT Service Management**, First Edition, September 2021, www.ispe.org.

            
4. 30.**ISPE Baseline Pharmaceutical Engineering Guide, Volume 5 — Commissioning and Qualification**, Second Edition, June 2019, www.ispe.org.

            
5. 34.**ISPE GAMP Good Practice Guide: A Risk-Based Approach to Operation of GxP Computerized Systems**, First Edition, January 2010, www.ispe.org.

            
6. 35.**ISPE GAMP Guide: Records and Data Integrity**, First Edition, March 2017, www.ispe.org.

            
7. 36.**ISPE GAMP RDI Good Practice Guide: Data Integrity by Design**, First Edition, October 2020, www.ispe.org.

            
8. 38.**ISPE GAMP Series**, www.ispe.org.

            
9. 49.**ISPE GAMP Good Practice Guide: IT Infrastructure Control and Compliance**, Second Edition, August 2017, www.ispe.org.

            
10. 50.**ISPE GAMP Good Practice Guide: A Risk-Based Approach to GxP Compliant Laboratory Computerized Systems**, Second Edition, October 2012, www.ispe.org.

            
11. 57.**ISPE GAMP RDI Good Practice Guide: Data Integrity — Key Concepts**, First Edition, October 2018, www.ispe.org.

            
12. 61.**ISPE GAMP Good Practice Guide: A Risk-Based Approach to GxP Process Control Systems**, Second Edition, February 2011, www.ispe.org.

            
13. 64.**ISPE GAMP Good Practice Guide Series**, www.ispe.org.

            
14. 65.**ISPE GAMP Good Practice Guide: A Risk-Based Approach to Calibration Management**, Second Edition, November 2010, www.ispe.org.

            
15. 77.**ISPE GAMP Community of Practice**, www.ispe.org.

            
16. 80.**ISPE GAMP Good Practice Guide: Global Information Systems Control and Compliance**, Second Edition, February 2017, www.ispe.org.

            
17. 90.**ISPE GAMP Good Practice Guide: Manufacturing Execution Systems — A Strategic and Program Management Approach**, First Edition, February 2010, www.ispe.org.

            
18. 93.**ISPE GAMP RDI Good Practice Guide: Data Integrity — Manufacturing Records**, First Edition, May 2019, www.ispe.org.
...
1. 22.**PIC/S Guidance: PI 011-3** Good Practices for Computerised Systems in Regulated "GXP" Environments, 25 September 2007, www.picscheme.org.

            
2. 31.**PIC/S Guidance: PI 041-1** Good Practices for Data Management and Integrity in Regulated GMP/GDP Environments, 1 July 2021, www.picscheme.org.

            
3. 91.**WHO Technical Report Series No. 996, Annex 5**: Guidance on good data and record management practices, WHO, 2016, https://apps.who.int/medicinedocs/documents/s22402en/s22402en.pdf.

            
4. 92.**PIC/S Guide: PE 009-16 (Annexes)** — Guide to Good Manufacturing Practice for Medicinal Products Annexes, February 2022, www.picscheme.org.
...
1. 3.**ISACA Capability Maturity Model Integration (CMMI)**, https://cmmiinstitute.com.

            
2. 4.**ISO 12207:2017** Systems and software engineering — Software life cycle processes, ISO, www.iso.org.

            
3. 5.**ITIL Foundation, ITIL 4 Edition**, London, UK: Axelos, 2019, www.axelos.com.

            
4. 8.**ASTM Standard E2500-20**, "Standard Guide for Specification, Design, and Verification of Pharmaceutical and Biopharmaceutical Manufacturing Systems and Equipment," ASTM International, West Conshohocken, PA, www.astm.org.

            
5. 9.US FDA CDRH, **Case for Quality**, FDA, www.fda.gov.

            
6. 18.**IEC 62304** Medical Device Software — Software Life Cycle Processes, Edition 1.1, 2015, IEC, www.iec.ch.

            
7. 19.**Sarbanes-Oxley Act of 2002**, US Securities and Exchange Commission (SEC), www.sec.gov.

            
8. 27.**UK MHRA**, www.gov.uk/government/organisations/medicines-and-healthcare-products-regulatory-agency.

            
9. 28.**Japan PMDA**, www.pmda.go.jp/english.

            
10. 37.**MHRA Guidance: 'GXP' Data Integrity Guidance and Definitions**, Revision 1, March 2018, www.gov.uk.

            
11. 40.**American Institute of CPAs (AICPA)**, www.aicpa.org.

            
12. 48.Simmon, E., NIST SP 500-322, **"Evaluation of Cloud Computing Services Based on NIST SP 800-145"**, NIST, February 2018, https://csrc.nist.gov.

            
13. 55.AICPA, **"2017 Trust Services Criteria for Security, Availability, Processing Integrity, Confidentiality, and Privacy"**, March 2020, www.aicpa.org.

            
14. 67.**IEEE Standards Association**, https://standards.ieee.org.

            
15. 68.**ISTQB (International Software Testing Qualifications Board)**, www.istqb.org.

            
16. 70.**Manifesto for Agile Software Development**, 2001, https://agilemanifesto.org.

            
17. 71.**The Scrum Framework Poster**, Scrum.org, www.scrum.org.

            
18. 83.**ASTM International**, West Conshohocken, PA, www.astm.org.

            
19. 86.**International Society of Automation (ISA)**, www.isa.org.

            
20. 96.**IEEE Standards Collection, Software Engineering**, Institute of Electrical and Electronics Engineers, 1994.

            
21. 98."Definition of BLOCKCHAIN," Merriam-Webster, www.merriam-webster.com/dictionary.
...
## Appendix G2, Section 53.1 — Acronyms & Abbreviations /
...
## Appendix G2, Section 53.2 — Definitions /
...
- Good Manufacturing Practice (GMP) — pharmaceutical, including API, veterinary, and blood
...
Testing that ignores the internal mechanism or structure of a system or component and focuses on the outputs generated in response to selected inputs and execution conditions. Also called black-box testing or input/output driven testing. Contrast with testing, structural.
...
Testing that takes into account the internal mechanism [structure] of a system or component. Types include branch testing, path testing, statement testing. Also called white-box testing, glass-box testing, logic driven testing. Contrast with functional testing.
...
The pharmaceutical customer or user organization contracting a supplier to provide a product. In the context of this document it is not intended to apply only to individuals who use the system, and is synonymous with customer.
...
Source: ISO 9000 [1]; ASTM E2500 [8]
...
- Over 106 cited documents spanning ISO standards, ICH guidelines, FDA regulations, EU directives, ISPE/GAMP guides, PIC/S, WHO, and ASTM standards.

                
- The three pillars of GAMP 5's regulatory framework: 21 CFR Part 11 (US electronic records), EU GMP Annex 11 (EU computerized systems), and ICH Q9 (quality risk management).

                
- 21 CFR Part 11 and EU Annex 11 have overlapping but not identical requirements; companies supplying both markets must satisfy the stricter of the two.

                
- ICH Q9 provides the scientific foundation for GAMP 5's risk-based approach and defines core risk terminology.

                
- When citing GAMP 5 in validation documents, use the full citation: ISPE GAMP 5, Second Edition, 2022, www.ispe.org.
...
- 96 acronyms defined, from AI to XaaS, covering all major GxP and IT terms used in GAMP 5.

                
- Key distinction: Verification (ASTM umbrella term) ≥ Validation (life cycle compliance) ≥ Qualification (IQ/OQ/PQ phases).

                
- Process Owner owns data integrity; System Owner owns system availability — these are distinct roles with different accountability.

                
- Periodic Review is a formal GAMP 5-defined requirement, not optional — it confirms the system remains in a validated state.

                
- COTS software has fitness demonstrated by broad commercial use; custom code requires full development life cycle controls.

                
- GxP Regulation extends beyond GMP to include GLP, GCP, GDP, GVP, and medical device regulations depending on the business context.
